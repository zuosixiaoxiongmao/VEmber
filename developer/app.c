...
typedef struct multi_return_u32_int multi_return_u32_int;
typedef struct multi_return_int_int_u32 multi_return_int_int_u32;
typedef struct multi_return_int_int_int_bool multi_return_int_int_int_bool;
typedef struct multi_return_int_bool_bool_string_int multi_return_int_bool_bool_string_int;
typedef struct multi_return_regex__RE_int_int multi_return_regex__RE_int_int;
...
typedef struct regex__Token regex__Token;
typedef struct regex__RE regex__RE;
typedef struct regex__BslsStruct regex__BslsStruct;
typedef struct regex__CharClass regex__CharClass;
typedef struct regex__StateObj regex__StateObj;
typedef struct regex__Re_group regex__Re_group;
typedef struct main__Point main__Point;
typedef struct main__Vector3D main__Vector3D;
typedef struct main__Wzx main__Wzx;
...
typedef struct _result_regex__RE _result_regex__RE;
...
typedef enum {
	regex__BSLS_parse_state__start, // 
	regex__BSLS_parse_state__bsls_found, // +1
	regex__BSLS_parse_state__bsls_char, // +2
	regex__BSLS_parse_state__normal_char, // +3
}  regex__BSLS_parse_state;

typedef enum {
	regex__CharClass_parse_state__start, // 
	regex__CharClass_parse_state__in_char, // +1
	regex__CharClass_parse_state__in_bsls, // +2
	regex__CharClass_parse_state__separator, // +3
	regex__CharClass_parse_state__finish, // +4
}  regex__CharClass_parse_state;

typedef enum {
	regex__Quant_parse_state__start, // 
	regex__Quant_parse_state__min_parse, // +1
	regex__Quant_parse_state__comma_checked, // +2
	regex__Quant_parse_state__max_parse, // +3
	regex__Quant_parse_state__greedy, // +4
	regex__Quant_parse_state__gredy_parse, // +5
	regex__Quant_parse_state__finish, // +6
}  regex__Quant_parse_state;

typedef enum {
	regex__Group_parse_state__start, // 
	regex__Group_parse_state__q_mark, // +1
	regex__Group_parse_state__q_mark1, // +2
	regex__Group_parse_state__p_status, // +3
	regex__Group_parse_state__p_start, // +4
	regex__Group_parse_state__p_end, // +5
	regex__Group_parse_state__p_in_name, // +6
	regex__Group_parse_state__finish, // +7
}  regex__Group_parse_state;

typedef enum {
	regex__Match_state__start = 0, // 0
	regex__Match_state__stop, // 0+1
	regex__Match_state__end, // 0+2
	regex__Match_state__new_line, // 0+3
	regex__Match_state__ist_load, // 0+4
	regex__Match_state__ist_next, // 0+5
	regex__Match_state__ist_next_ks, // 0+6
	regex__Match_state__ist_quant_p, // 0+7
	regex__Match_state__ist_quant_n, // 0+8
	regex__Match_state__ist_quant_pg, // 0+9
	regex__Match_state__ist_quant_ng, // 0+10
}  regex__Match_state;
...
typedef array Array_regex__Token;
typedef array Array_regex__CharClass;
typedef array Array_regex__StateObj;
typedef array Array_regex__Re_group;
...
typedef array Array_regex__BslsStruct;
typedef array Array_u32;
typedef array Array_regex__Match_state;
typedef int C__BOOL;
...
typedef bool (*regex__FnValidator)(u8);
typedef void (*regex__FnLog)(string);
typedef string (*regex__FnReplace)(regex__RE,string,int,int);
...
struct regex__RE {
	Array_regex__Token prog;
	int prog_len;
	Array_regex__CharClass cc;
	int cc_index;
	int group_count;
	Array_int groups;
	int group_max_nested;
	int group_max;
	Array_regex__StateObj state_list;
	bool group_csave_flag;
	Array_int group_csave;
	Map_string_int group_map;
	Array_int group_stack;
	Array_int group_data;
	int flag;
	int debug;
	regex__FnLog log_func;
	string query;
};
...
struct regex__BslsStruct {
	rune ch;
	regex__FnValidator validator;
};

struct regex__Re_group {
	int start;
	int end;
};
...
struct multi_return_u32_int {
	u32 arg0;
	int arg1;
};

struct multi_return_int_int_u32 {
	int arg0;
	int arg1;
	u32 arg2;
};

struct multi_return_int_int_int_bool {
	int arg0;
	int arg1;
	int arg2;
	bool arg3;
...
struct multi_return_int_bool_bool_string_int {
	int arg0;
	bool arg1;
	bool arg2;
	string arg3;
...
struct multi_return_regex__RE_int_int {
	regex__RE arg0;
	int arg1;
	int arg2;
};
...
struct _result_regex__RE {
	bool is_error;
	IError err;
	byte data[sizeof(regex__RE) > 1 ? sizeof(regex__RE) : 1];
};
...
VV_LOCAL_SYMBOL  int compare_17736469186926633853_RepIndex_by_idx(RepIndex* a, RepIndex* b) {
...
VV_LOCAL_SYMBOL int regex__utf8util_char_len(u8 b);
VV_LOCAL_SYMBOL multi_return_u32_int regex__RE_get_char(regex__RE re, string in_txt, int i);
VV_LOCAL_SYMBOL multi_return_u32_int regex__RE_get_charb(regex__RE re, u8* in_txt, int i);
VV_LOCAL_SYMBOL bool regex__is_alnum(u8 in_char);
VV_LOCAL_SYMBOL bool regex__is_not_alnum(u8 in_char);
VV_LOCAL_SYMBOL bool regex__is_space(u8 in_char);
VV_LOCAL_SYMBOL bool regex__is_not_space(u8 in_char);
VV_LOCAL_SYMBOL bool regex__is_digit(u8 in_char);
VV_LOCAL_SYMBOL bool regex__is_not_digit(u8 in_char);
VV_LOCAL_SYMBOL bool regex__is_lower(u8 in_char);
VV_LOCAL_SYMBOL bool regex__is_upper(u8 in_char);
string regex__RE_get_parse_error_string(regex__RE re, int err);
VV_LOCAL_SYMBOL string regex__utf8_str(rune ch);
VV_LOCAL_SYMBOL void regex__simple_log(string txt);
VV_LOCAL_SYMBOL void regex__Token_reset(regex__Token* tok);
void regex__RE_reset(regex__RE* re);
VV_LOCAL_SYMBOL void regex__RE_reset_src(regex__RE* re);
VV_LOCAL_SYMBOL multi_return_int_int regex__RE_parse_bsls(regex__RE* re, string in_txt, int in_i);
VV_LOCAL_SYMBOL string regex__RE_get_char_class(regex__RE* re, int pc);
VV_LOCAL_SYMBOL bool regex__RE_check_char_class(regex__RE* re, int pc, rune ch);
VV_LOCAL_SYMBOL multi_return_int_int_u32 regex__RE_parse_char_class(regex__RE* re, string in_txt, int in_i);
VV_LOCAL_SYMBOL multi_return_int_int_int_bool regex__RE_parse_quantifier(regex__RE* re, string in_txt, int in_i);
VV_LOCAL_SYMBOL multi_return_int_bool_bool_string_int regex__RE_parse_groups(regex__RE* re, string in_txt, int in_i);
VV_LOCAL_SYMBOL multi_return_int_int regex__RE_impl_compile(regex__RE* re, string in_txt);
string regex__RE_get_code(regex__RE* re);
string regex__RE_get_query(regex__RE* re);
VV_LOCAL_SYMBOL void regex__RE_group_continuous_save(regex__RE* re, int g_index);
VV_LOCAL_SYMBOL string regex__state_str(regex__Match_state s);
multi_return_int_int regex__RE_match_base(regex__RE* re, u8* in_txt, int in_txt_len);
_result_void regex__RE_compile_opt(regex__RE* re, string pattern);
regex__RE regex__new(void);
_result_regex__RE regex__regex_opt(string pattern);
multi_return_regex__RE_int_int regex__regex_base(string pattern);
multi_return_int_int regex__RE_get_group_bounds_by_name(regex__RE* re, string group_name);
string regex__RE_get_group_by_name(regex__RE* re, string in_txt, string group_name);
string regex__RE_get_group_by_id(regex__RE* re, string in_txt, int group_id);
multi_return_int_int regex__RE_get_group_bounds_by_id(regex__RE* re, int group_id);
Array_regex__Re_group regex__RE_get_group_list(regex__RE* re);
multi_return_int_int regex__RE_match_string(regex__RE* re, string in_txt);
bool regex__RE_matches_string(regex__RE* re, string in_txt);
multi_return_int_int regex__RE_find(regex__RE* re, string in_txt);
multi_return_int_int regex__RE_find_from(regex__RE* re, string in_txt, int start);
Array_int regex__RE_find_all(regex__RE* re, string in_txt);
Array_string regex__RE_split(regex__RE* re, string in_txt);
Array_string regex__RE_find_all_str(regex__RE* re, string in_txt);
string regex__RE_replace_simple(regex__RE* re, string in_txt, string repl);
string regex__RE_replace_by_fn(regex__RE* re, string in_txt, string (*repl_fn)(regex__RE re, string in_txt, int start, int end));
VV_LOCAL_SYMBOL string regex__RE_parsed_replace_string(regex__RE* re, string in_txt, string repl);
string regex__RE_replace(regex__RE* re, string in_txt, string repl_str);
string regex__RE_replace_n(regex__RE* re, string in_txt, string repl_str, int count);
VV_LOCAL_SYMBOL void main__run_regex(void);
VV_LOCAL_SYMBOL main__Vector3D main__look_at(main__Vector3D point, main__Vector3D dir);
...
string _const_regex__v_regex_version; // a string literal, inited later
#define _const_regex__max_code_len 256
#define _const_regex__max_quantifier 1073741824
#define _const_regex__no_match_found -1
#define _const_regex__compile_ok 0
#define _const_regex__err_char_unknown -2
#define _const_regex__err_undefined -3
#define _const_regex__err_internal_error -4
#define _const_regex__err_cc_alloc_overflow -5
#define _const_regex__err_syntax_error -6
#define _const_regex__err_groups_overflow -7
#define _const_regex__err_groups_max_nested -8
#define _const_regex__err_group_not_balanced -9
#define _const_regex__err_group_qm_notation -10
#define _const_regex__err_invalid_or_with_cc -11
#define _const_regex__err_neg_group_quantifier -12
#define _const_regex__err_consecutive_dots -13
#define _const_regex__f_nl 1
#define _const_regex__f_ms 2
#define _const_regex__f_me 4
#define _const_regex__f_efm 256
#define _const_regex__f_bin 512
#define _const_regex__f_src 131072
#define _const_regex__cc_null 0
#define _const_regex__cc_char 1
#define _const_regex__cc_int 2
#define _const_regex__cc_bsls 3
#define _const_regex__cc_end 4
...
Array_rune _const_regex__spaces; // inited later
Array_rune _const_regex__new_line_list; // inited later
 const u32 _const_regex__ist_simple_char = 2147483647; // precomputed2
 const u32 _const_regex__ist_char_class = 3506438144; // precomputed2
 const u32 _const_regex__ist_char_class_pos = 3489660928; // precomputed2
 const u32 _const_regex__ist_char_class_neg = 3506438144; // precomputed2
 const u32 _const_regex__ist_dot_char = 2550136832; // precomputed2
 const u32 _const_regex__ist_bsls_char = 2415919104; // precomputed2
 const u32 _const_regex__ist_or_branch = 2432696320; // precomputed2
 const u32 _const_regex__ist_group_start = 2449473536; // precomputed2
 const u32 _const_regex__ist_group_end = 2483027968; // precomputed2
 const u32 _const_regex__ist_prog_end = 2281701376; // precomputed2
Array_regex__BslsStruct _const_regex__bsls_validator_array; // inited later
Array_rune _const_regex__bsls_escape_list; // inited later
Array_rune _const_regex__quntifier_chars; // inited later
 main__Wzx  wzx; // global4
...
VNORETURN VV_LOCAL_SYMBOL void panic_debug(int line_no, string file, string mod, string fn_name, string s) {
	...
	#else
	{
		...
		eprintln( str_intp(2, _MOV((StrIntpData[]){{_SLIT("   v hash: "), 0xfe10, {.d_s = _SLIT("ae5421e")}}, {_SLIT0, 0, { .d_c = 0 }}})));
		eprintln(_SLIT("========================================="));
		#if defined(_VNATIVE)
		{
			exit(1);
...
VV_LOCAL_SYMBOL void builtin_init(void) {
	...
	_result_void _t2 = at_exit((voidptr)restore_codepage);
	if (_t2.is_error) {
		IError err = _t2.err;
	}
...
string winapi_lasterr_str(void) {
	...
	string err_msg = (res == 0U ? ( str_intp(2, _MOV((StrIntpData[]){{_SLIT("Win-API error "), 0xfe06, {.d_u32 = err_msg_id}}, {_SLIT0, 0, { .d_c = 0 }}}))) : (string_from_wide(msgbuf)));
	return err_msg;
}
...
string IError_str(IError err) {
	return ((err._typ == _IError_None___index)? (_SLIT("none")) : (err._typ == _IError_Error_index)? (Error_msg(/*rec*/*(err._Error))) : (err._typ == _IError_MessageError_index)? (MessageError_msg(/*rec*/*(err._MessageError))) : ( str_intp(3, _MOV((StrIntpData[]){{_SLIT0, 0xfe10, {.d_s = charptr_vstring_literal( /* IError */ v_typeof_interface_IError( (err)._typ ))}}, {_SLIT(": "), 0xfe10, {.d_s = IError_name_table[err._typ]._method_msg(err._object)}}, {_SLIT0, 0, { .d_c = 0 }}}))));
}
...
string string_replace_each(string s, Array_string vals) {
	...
	qsort(idxs.data, idxs.len, idxs.element_size, (int (*)(const void *, const void *))&compare_17736469186926633853_RepIndex_by_idx);
	u8* b = malloc_noscan((int)(new_len + 1));
	int idx_pos = 0;
...
string string_trim(string s, string cutset) {
	...
	multi_return_int_int mr_43299 = string_trim_indexes(s, cutset);
	int left = mr_43299.arg0;
	int right = mr_43299.arg1;
...
// Attr: [inline]
inline VV_LOCAL_SYMBOL int regex__utf8util_char_len(u8 b) {
	int _t1 = (int_literal)(((((0xe5000000 >> ((((b >> 3)) & 0x1e)))) & 3)) + 1);
	return _t1;
}

// Attr: [direct_array_access]
// Attr: [inline]
inline VV_LOCAL_SYMBOL multi_return_u32_int regex__RE_get_char(regex__RE re, string in_txt, int i) {
	u8 ini = in_txt.str[i];
	if (((re.flag & _const_regex__f_bin)) != 0 || (ini & 0x80) == 0) {
		return (multi_return_u32_int){.arg0=((u32)(ini)), .arg1=1};
	}
	int char_len = regex__utf8util_char_len(ini);
	int tmp = 0;
	u32 ch = ((u32)(0U));
	for (;;) {
		if (!(tmp < char_len)) break;
		ch = (((ch << 8U)) | in_txt.str[(int)(i + tmp)]);
		tmp++;
	}
	return (multi_return_u32_int){.arg0=ch, .arg1=char_len};
}

// Attr: [direct_array_access]
// Attr: [inline]
inline VV_LOCAL_SYMBOL multi_return_u32_int regex__RE_get_charb(regex__RE re, u8* in_txt, int i) {
	if (((re.flag & _const_regex__f_bin)) != 0 || (in_txt[i] & 0x80) == 0) {
		return (multi_return_u32_int){.arg0=((u32)(in_txt[i])), .arg1=1};
	}
	int char_len = regex__utf8util_char_len(in_txt[i]);
	int tmp = 0;
	u32 ch = ((u32)(0U));
	for (;;) {
		if (!(tmp < char_len)) break;
		ch = (((ch << 8U)) | in_txt[(int)(i + tmp)]);
		tmp++;
	}
	return (multi_return_u32_int){.arg0=ch, .arg1=char_len};
}
...
// Attr: [inline]
inline VV_LOCAL_SYMBOL bool regex__is_alnum(u8 in_char) {
	rune tmp = (rune)(in_char - 'A');
	if (tmp <= 25) {
		bool _t1 = true;
		return _t1;
	}
...
// Attr: [inline]
inline VV_LOCAL_SYMBOL bool regex__is_not_alnum(u8 in_char) {
	bool _t1 = !regex__is_alnum(in_char);
	return _t1;
}

// Attr: [inline]
inline VV_LOCAL_SYMBOL bool regex__is_space(u8 in_char) {
	bool _t1 = (Array_rune_contains(_const_regex__spaces, in_char));
	return _t1;
}

// Attr: [inline]
inline VV_LOCAL_SYMBOL bool regex__is_not_space(u8 in_char) {
	bool _t1 = !regex__is_space(in_char);
	return _t1;
}

// Attr: [inline]
inline VV_LOCAL_SYMBOL bool regex__is_digit(u8 in_char) {
	rune tmp = (rune)(in_char - '0');
	bool _t1 = tmp <= 0x09;
	return _t1;
}

// Attr: [inline]
inline VV_LOCAL_SYMBOL bool regex__is_not_digit(u8 in_char) {
	bool _t1 = !regex__is_digit(in_char);
	return _t1;
}

// Attr: [inline]
inline VV_LOCAL_SYMBOL bool regex__is_lower(u8 in_char) {
	rune tmp = (rune)(in_char - 'a');
	bool _t1 = tmp <= 25;
	return _t1;
}
...
// Attr: [inline]
inline VV_LOCAL_SYMBOL bool regex__is_upper(u8 in_char) {
	rune tmp = (rune)(in_char - 'A');
	bool _t1 = tmp <= 25;
	return _t1;
}
...
string regex__RE_get_parse_error_string(regex__RE re, int err) {
	...
	if (err == (_const_regex__compile_ok)) {
		string _t1 = _SLIT("compile_ok");
		return _t1;
	}
	else if (err == (_const_regex__no_match_found)) {
		string _t2 = _SLIT("no_match_found");
		return _t2;
	}
	else if (err == (_const_regex__err_char_unknown)) {
		string _t3 = _SLIT("err_char_unknown");
		return _t3;
	}
	else if (err == (_const_regex__err_undefined)) {
		string _t4 = _SLIT("err_undefined");
		return _t4;
	}
	else if (err == (_const_regex__err_internal_error)) {
		string _t5 = _SLIT("err_internal_error");
		return _t5;
	}
	else if (err == (_const_regex__err_cc_alloc_overflow)) {
		string _t6 = _SLIT("err_cc_alloc_overflow");
		return _t6;
	}
	else if (err == (_const_regex__err_syntax_error)) {
		string _t7 = _SLIT("err_syntax_error");
		return _t7;
	}
	else if (err == (_const_regex__err_groups_overflow)) {
		string _t8 = _SLIT("err_groups_overflow");
		return _t8;
	}
	else if (err == (_const_regex__err_groups_max_nested)) {
		string _t9 = _SLIT("err_groups_max_nested");
		return _t9;
	}
	else if (err == (_const_regex__err_group_not_balanced)) {
		string _t10 = _SLIT("err_group_not_balanced");
		return _t10;
	}
	else if (err == (_const_regex__err_group_qm_notation)) {
		string _t11 = _SLIT("err_group_qm_notation");
		return _t11;
	}
	else if (err == (_const_regex__err_invalid_or_with_cc)) {
		string _t12 = _SLIT("err_invalid_or_with_cc");
		return _t12;
	}
	else if (err == (_const_regex__err_neg_group_quantifier)) {
		string _t13 = _SLIT("err_neg_group_quantifier");
		return _t13;
	}
	else if (err == (_const_regex__err_consecutive_dots)) {
		string _t14 = _SLIT("err_consecutive_dots");
		return _t14;
	}
	else {
		string _t15 = _SLIT("err_unknown");
		return _t15;
	}
	return (string){.str=(byteptr)"", .is_lit=1};
}
...
// Attr: [inline]
inline VV_LOCAL_SYMBOL string regex__utf8_str(rune ch) {
	int i = 4;
	string res = _SLIT("");
	for (;;) {
		if (!(i > 0)) break;
		u8 v = ((u8)((((ch >> ((int)(((int)(i - 1)) * 8)))) & 0xFF)));
		if (v != 0) {
			res = string__plus(res,  str_intp(2, _MOV((StrIntpData[]){{_SLIT0, 0x2fe21, {.d_c = v}}, {_SLIT0, 0, { .d_c = 0 }}})));
		}
		i--;
	}
	return res;
...
// TypeDecl
// Attr: [inline]
inline VV_LOCAL_SYMBOL void regex__Token_reset(regex__Token* tok) {
	tok->rep = 0;
}
...
// Attr: [direct_array_access]
// Attr: [inline]
inline void regex__RE_reset(regex__RE* re) {
	re->cc_index = 0;
	int i = 0;
	for (;;) {
		if (!(i < re->prog_len)) break;
		((regex__Token*)re->prog.data)[i].group_rep = 0;
		((regex__Token*)re->prog.data)[i].rep = 0;
		i++;
	}
	if (re->group_count > 0) {
		if (re->groups.len == 0) {
			re->groups = __new_array_with_default_noscan((int)(re->group_count * 2), 0, sizeof(int), &(int[]){-1});
		} else {
			i = 0;
			for (;;) {
				if (!(i < re->groups.len)) break;
				((int*)re->groups.data)[i] = -1;
				i++;
			}
		}
	}
	if (re->group_csave_flag == true) {
		array_clear(&re->group_csave);
	}
	array_clear(&re->state_list);
	array_clear(&re->group_stack);
}
...
VV_LOCAL_SYMBOL multi_return_int_int regex__RE_parse_bsls(regex__RE* re, string in_txt, int in_i) {
	regex__BSLS_parse_state status = regex__BSLS_parse_state__start;
	int i = in_i;
	for (;;) {
		if (!(i < in_txt.len)) break;
		multi_return_u32_int mr_11313 = regex__RE_get_char(/*rec*/*re, in_txt, i);
		u32 char_tmp = mr_11313.arg0;
		int char_len = mr_11313.arg1;
		u8 ch = ((u8)(char_tmp));
		if (status == regex__BSLS_parse_state__start && ch == '\\') {
			status = regex__BSLS_parse_state__bsls_found;
			i += char_len;
			continue;
		}
		if (status == regex__BSLS_parse_state__bsls_found) {
			for (int c = 0; c < _const_regex__bsls_validator_array.len; ++c) {
				regex__BslsStruct x = ((regex__BslsStruct*)_const_regex__bsls_validator_array.data)[c];
				if (x.ch == ch) {
					return (multi_return_int_int){.arg0=c, .arg1=(int)((int)(i - in_i) + 1)};
				}
			}
			status = regex__BSLS_parse_state__normal_char;
			continue;
		}
		if (status == regex__BSLS_parse_state__normal_char) {
			if ((Array_rune_contains(_const_regex__bsls_escape_list, ch))) {
				return (multi_return_int_int){.arg0=_const_regex__no_match_found, .arg1=(int)((int)(i - in_i) + 1)};
			}
			return (multi_return_int_int){.arg0=_const_regex__err_syntax_error, .arg1=(int)((int)(i - in_i) + 1)};
		}
		break;
	}
	return (multi_return_int_int){.arg0=_const_regex__err_syntax_error, .arg1=i};
}

VV_LOCAL_SYMBOL string regex__RE_get_char_class(regex__RE* re, int pc) {
	Array_u8 buf = __new_array_with_default_noscan((re->cc.len), 0, sizeof(u8), 0);
	u8* buf_ptr = ((u8*)(&buf));
	int cc_i = (*(regex__Token*)array_get(re->prog, pc)).cc_index;
	int i = 0;
	int tmp = 0;
	for (;;) {
		if (!(cc_i >= 0 && cc_i < re->cc.len && (*(regex__CharClass*)array_get(re->cc, cc_i)).cc_type != _const_regex__cc_end)) break;
		if ((*(regex__CharClass*)array_get(re->cc, cc_i)).cc_type == _const_regex__cc_bsls) {
			{ // Unsafe block
				buf_ptr[i] = '\\';
				i++;
				buf_ptr[i] = ((u8)((*(regex__CharClass*)array_get(re->cc, cc_i)).ch0));
				i++;
			}
		} else if ((*(regex__CharClass*)array_get(re->cc, cc_i)).ch0 == (*(regex__CharClass*)array_get(re->cc, cc_i)).ch1) {
			tmp = 3;
			for (;;) {
				if (!(tmp >= 0)) break;
				u8 x = ((u8)(((((*(regex__CharClass*)array_get(re->cc, cc_i)).ch0 >> ((int)(tmp * 8)))) & 0xFF)));
				if (x != 0) {
					{ // Unsafe block
						buf_ptr[i] = x;
						i++;
			...
			for (;;) {
				if (!(tmp >= 0)) break;
				u8 x = ((u8)(((((*(regex__CharClass*)array_get(re->cc, cc_i)).ch1 >> ((int)(tmp * 8)))) & 0xFF)));
				if (x != 0) {
					{ // Unsafe block
						buf_ptr[i] = x;
						i++;
...
VV_LOCAL_SYMBOL bool regex__RE_check_char_class(regex__RE* re, int pc, rune ch) {
	...
	for (;;) {
		if (!(cc_i >= 0 && cc_i < re->cc.len && (*(regex__CharClass*)array_get(re->cc, cc_i)).cc_type != _const_regex__cc_end)) break;
		if ((*(regex__CharClass*)array_get(re->cc, cc_i)).cc_type == _const_regex__cc_bsls) {
			if ((*(regex__CharClass*)array_get(re->cc, cc_i)).validator(((u8)(ch)))) {
				bool _t1 = true;
				return _t1;
			}
		} else if (ch >= (*(regex__CharClass*)array_get(re->cc, cc_i)).ch0 && ch <= (*(regex__CharClass*)array_get(re->cc, cc_i)).ch1) {
			bool _t2 = true;
			return _t2;
		}
		cc_i++;
...
VV_LOCAL_SYMBOL multi_return_int_int_u32 regex__RE_parse_char_class(regex__RE* re, string in_txt, int in_i) {
	regex__CharClass_parse_state status = regex__CharClass_parse_state__start;
	int i = in_i;
	int tmp_index = re->cc_index;
	int res_index = re->cc_index;
	u32 cc_type = ((u32)(_const_regex__ist_char_class_pos));
	for (;;) {
		if (!(i < in_txt.len)) break;
		if (tmp_index >= re->cc.len) {
			return (multi_return_int_int_u32){.arg0=_const_regex__err_cc_alloc_overflow, .arg1=0, .arg2=((u32)(0U))};
		}
		multi_return_u32_int mr_14778 = regex__RE_get_char(/*rec*/*re, in_txt, i);
		u32 char_tmp = mr_14778.arg0;
		int char_len = mr_14778.arg1;
		u8 ch = ((u8)(char_tmp));
		if (status == regex__CharClass_parse_state__start && ch == '^') {
			cc_type = ((u32)(_const_regex__ist_char_class_neg));
			i += char_len;
			continue;
		}
		if (status == regex__CharClass_parse_state__start && ch == '-') {
			(*(regex__CharClass*)array_get(re->cc, tmp_index)).cc_type = _const_regex__cc_char;
			(*(regex__CharClass*)array_get(re->cc, tmp_index)).ch0 = char_tmp;
			(*(regex__CharClass*)array_get(re->cc, tmp_index)).ch1 = char_tmp;
			i += char_len;
			tmp_index++;
			continue;
		}
		if ((status == regex__CharClass_parse_state__start || status == regex__CharClass_parse_state__in_char) && ch == '\\') {
			status = regex__CharClass_parse_state__in_bsls;
			i += char_len;
			continue;
		}
		if (status == regex__CharClass_parse_state__in_bsls) {
			for (int c = 0; c < _const_regex__bsls_validator_array.len; ++c) {
				regex__BslsStruct x = ((regex__BslsStruct*)_const_regex__bsls_validator_array.data)[c];
				if (x.ch == ch) {
					(*(regex__CharClass*)array_get(re->cc, tmp_index)).cc_type = _const_regex__cc_bsls;
					(*(regex__CharClass*)array_get(re->cc, tmp_index)).ch0 = (*(regex__BslsStruct*)array_get(_const_regex__bsls_validator_array, c)).ch;
					(*(regex__CharClass*)array_get(re->cc, tmp_index)).ch1 = (*(regex__BslsStruct*)array_get(_const_regex__bsls_validator_array, c)).ch;
					(*(regex__CharClass*)array_get(re->cc, tmp_index)).validator = (voidptr)(*(regex__BslsStruct*)array_get(_const_regex__bsls_validator_array, c)).validator;
					i += char_len;
					tmp_index++;
					status = regex__CharClass_parse_state__in_char;
					break;
				}
			}
			if (status == regex__CharClass_parse_state__in_bsls) {
		...
		if ((status == regex__CharClass_parse_state__start || status == regex__CharClass_parse_state__in_char) && ch != '-' && ch != ']') {
			status = regex__CharClass_parse_state__in_char;
			(*(regex__CharClass*)array_get(re->cc, tmp_index)).cc_type = _const_regex__cc_char;
			(*(regex__CharClass*)array_get(re->cc, tmp_index)).ch0 = char_tmp;
			(*(regex__CharClass*)array_get(re->cc, tmp_index)).ch1 = char_tmp;
		...
		if (status == regex__CharClass_parse_state__in_char && ch == '-') {
			status = regex__CharClass_parse_state__separator;
			i += char_len;
			continue;
		}
		if (status == regex__CharClass_parse_state__separator && ch != ']' && ch != '-') {
			status = regex__CharClass_parse_state__in_char;
			(*(regex__CharClass*)array_get(re->cc, (int)(tmp_index - 1))).cc_type = _const_regex__cc_int;
			(*(regex__CharClass*)array_get(re->cc, (int)(tmp_index - 1))).ch1 = char_tmp;
			i += char_len;
			continue;
		}
		if (status == regex__CharClass_parse_state__in_char && ch == ']') {
			(*(regex__CharClass*)array_get(re->cc, tmp_index)).cc_type = _const_regex__cc_end;
			(*(regex__CharClass*)array_get(re->cc, tmp_index)).ch0 = 0;
			(*(regex__CharClass*)array_get(re->cc, tmp_index)).ch1 = 0;
			re->cc_index = (int)(tmp_index + 1);
			return (multi_return_int_int_u32){.arg0=res_index, .arg1=(int)((int)(i - in_i) + 2), .arg2=cc_type};
		}
		i++;
	}
	return (multi_return_int_int_u32){.arg0=_const_regex__err_syntax_error, .arg1=0, .arg2=((u32)(0U))};
}

VV_LOCAL_SYMBOL multi_return_int_int_int_bool regex__RE_parse_quantifier(regex__RE* re, string in_txt, int in_i) {
	regex__Quant_parse_state status = regex__Quant_parse_state__start;
	int i = in_i;
	int q_min = 0;
	int q_max = 0;
	u8 ch = ((u8)(0));
	for (;;) {
		...
		if (regex__utf8util_char_len(ch) != 1) {
			return (multi_return_int_int_int_bool){.arg0=_const_regex__err_syntax_error, .arg1=i, .arg2=0, .arg3=false};
		}
		if (status == regex__Quant_parse_state__start && ch == ',') {
			q_min = 0;
			status = regex__Quant_parse_state__comma_checked;
			i++;
			continue;
		}
		if (status == regex__Quant_parse_state__start && regex__is_digit(ch)) {
			status = regex__Quant_parse_state__min_parse;
			q_min *= 10;
			q_min += ((int)((rune)(ch - '0')));
			i++;
			continue;
		}
		if (status == regex__Quant_parse_state__min_parse && regex__is_digit(ch)) {
			q_min *= 10;
			q_min += ((int)((rune)(ch - '0')));
			i++;
			continue;
		}
		if (status == regex__Quant_parse_state__min_parse && ch == ',') {
			status = regex__Quant_parse_state__comma_checked;
			i++;
			continue;
		}
		if (status == regex__Quant_parse_state__min_parse && ch == '}') {
			q_max = q_min;
			status = regex__Quant_parse_state__greedy;
			continue;
		}
		if (status == regex__Quant_parse_state__comma_checked && ch == '}') {
			q_max = _const_regex__max_quantifier;
			status = regex__Quant_parse_state__greedy;
			continue;
		}
		if (status == regex__Quant_parse_state__comma_checked && regex__is_digit(ch)) {
			status = regex__Quant_parse_state__max_parse;
			q_max *= 10;
			q_max += ((int)((rune)(ch - '0')));
			i++;
			continue;
		}
		if (status == regex__Quant_parse_state__max_parse && regex__is_digit(ch)) {
			q_max *= 10;
			q_max += ((int)((rune)(ch - '0')));
			i++;
			continue;
		}
		if (status == regex__Quant_parse_state__max_parse && ch == '}') {
			status = regex__Quant_parse_state__greedy;
			continue;
		}
		if (status == regex__Quant_parse_state__greedy) {
			if ((int)(i + 1) < in_txt.len) {
				i++;
				status = regex__Quant_parse_state__gredy_parse;
				continue;
			}
			return (multi_return_int_int_int_bool){.arg0=q_min, .arg1=q_max, .arg2=(int)((int)(i - in_i) + 2), .arg3=false};
		}
		if (status == regex__Quant_parse_state__gredy_parse) {
			if (ch == '?') {
				return (multi_return_int_int_int_bool){.arg0=q_min, .arg1=q_max, .arg2=(int)((int)(i - in_i) + 2), .arg3=true};
			} else {
				i--;
				return (multi_return_int_int_int_bool){.arg0=q_min, .arg1=q_max, .arg2=(int)((int)(i - in_i) + 2), .arg3=false};
			}
...
VV_LOCAL_SYMBOL multi_return_int_bool_bool_string_int regex__RE_parse_groups(regex__RE* re, string in_txt, int in_i) {
	regex__Group_parse_state status = regex__Group_parse_state__start;
	int i = in_i;
	string name = _SLIT("");
	for (;;) {
		if (!(i < in_txt.len && status != regex__Group_parse_state__finish)) break;
		multi_return_u32_int mr_20320 = regex__RE_get_char(/*rec*/*re, in_txt, i);
		u32 char_tmp = mr_20320.arg0;
		int char_len = mr_20320.arg1;
		u8 ch = ((u8)(char_tmp));
		if (status == regex__Group_parse_state__start && ch == '(') {
			status = regex__Group_parse_state__q_mark;
			i += char_len;
			continue;
		}
		if (status == regex__Group_parse_state__q_mark && ch == '?') {
			status = regex__Group_parse_state__q_mark1;
			i += char_len;
			continue;
		}
		if (status == regex__Group_parse_state__q_mark1 && ch == '!') {
			i += char_len;
			return (multi_return_int_bool_bool_string_int){.arg0=0, .arg1=false, .arg2=true, .arg3=name, .arg4=i};
		}
		if (status == regex__Group_parse_state__q_mark1 && ch == ':') {
			i += char_len;
			return (multi_return_int_bool_bool_string_int){.arg0=0, .arg1=false, .arg2=false, .arg3=name, .arg4=i};
		}
		if (status == regex__Group_parse_state__q_mark1 && ch == 'P') {
			status = regex__Group_parse_state__p_status;
			i += char_len;
			continue;
		}
		if (status == regex__Group_parse_state__q_mark1) {
			return (multi_return_int_bool_bool_string_int){.arg0=-2, .arg1=true, .arg2=false, .arg3=name, .arg4=i};
		}
		if (status == regex__Group_parse_state__p_status && ch == '<') {
			status = regex__Group_parse_state__p_start;
			i += char_len;
			continue;
		}
		if (status == regex__Group_parse_state__p_start && ch != '>') {
			status = regex__Group_parse_state__p_in_name;
			name = string__plus(name,  str_intp(2, _MOV((StrIntpData[]){{_SLIT0, 0x2fe21, {.d_c = ch}}, {_SLIT0, 0, { .d_c = 0 }}})));
			i += char_len;
			continue;
		}
		if (status == regex__Group_parse_state__p_in_name && ch != '>' && regex__is_alnum(ch)) {
			name = string__plus(name,  str_intp(2, _MOV((StrIntpData[]){{_SLIT0, 0x2fe21, {.d_c = ch}}, {_SLIT0, 0, { .d_c = 0 }}})));
			i += char_len;
			continue;
		}
		if (status == regex__Group_parse_state__p_in_name && ch == '>') {
			i += char_len;
			return (multi_return_int_bool_bool_string_int){.arg0=0, .arg1=true, .arg2=false, .arg3=name, .arg4=i};
		}
		if (status == regex__Group_parse_state__p_in_name) {
			return (multi_return_int_bool_bool_string_int){.arg0=-2, .arg1=true, .arg2=false, .arg3=name, .arg4=i};
		}
		return (multi_return_int_bool_bool_string_int){.arg0=0, .arg1=true, .arg2=false, .arg3=name, .arg4=i};
	}
...
VV_LOCAL_SYMBOL multi_return_int_int regex__RE_impl_compile(regex__RE* re, string in_txt) {
	...
	int pc = 0;
	int group_count = -1;
	Array_int group_stack = __new_array_with_default_noscan(re->group_max_nested, 0, sizeof(int), &(int[]){0});
	Array_int group_stack_txt_index = __new_array_with_default_noscan(re->group_max_nested, 0, sizeof(int), &(int[]){-1});
	int group_stack_index = -1;
	re->query = in_txt;
	i = 0;
	for (;;) {
		if (!(i < in_txt.len)) break;
		u32 char_tmp = ((u32)(0U));
		int char_len = 0;
		multi_return_u32_int mr_22584 = regex__RE_get_char(/*rec*/*re, in_txt, i);
		char_tmp = mr_22584.arg0;
		char_len = mr_22584.arg1;
		if (char_len == 1 && i == 0 && ((u8)(char_tmp)) == '^') {
			re->flag = _const_regex__f_ms;
			i = (int)(i + char_len);
			continue;
		}
		if (char_len == 1 && i == ((int)(in_txt.len - 1)) && ((u8)(char_tmp)) == '$') {
			re->flag = _const_regex__f_me;
			i = (int)(i + char_len);
			continue;
		}
		if (char_len == 1 && pc >= 0 && ((u8)(char_tmp)) == '(') {
			if (group_count > re->group_max) {
				return (multi_return_int_int){.arg0=_const_regex__err_groups_overflow, .arg1=(int)(i + 1)};
			}
			group_stack_index++;
			if (group_stack_index > re->group_max_nested) {
				return (multi_return_int_int){.arg0=_const_regex__err_groups_max_nested, .arg1=(int)(i + 1)};
			}
			multi_return_int_bool_bool_string_int mr_23305 = regex__RE_parse_groups(re, in_txt, i);
			int tmp_res = mr_23305.arg0;
			bool cgroup_flag = mr_23305.arg1;
			bool negate_flag = mr_23305.arg2;
			string cgroup_name = mr_23305.arg3;
			int next_i = mr_23305.arg4;
			if (tmp_res < -1) {
				return (multi_return_int_int){.arg0=_const_regex__err_group_qm_notation, .arg1=next_i};
			}
			i = next_i;
			if (cgroup_flag == true) {
				group_count++;
			...
			if (cgroup_name.len > 0) {
				if (_IN_MAP(ADDR(string, cgroup_name), ADDR(map, re->group_map))) {
					group_id = (int)((*(int*)map_get(ADDR(map, re->group_map), &(string[]){cgroup_name}, &(int[]){ 0 })) - 1);
					group_count--;
				} else {
					map_set(&re->group_map, &(string[]){cgroup_name}, &(int[]) { (int)(group_id + 1) });
				}
			}
			array_set(&group_stack_txt_index, group_stack_index, &(int[]) { i });
			array_set(&group_stack, group_stack_index, &(int[]) { pc });
			(*(regex__Token*)array_get(re->prog, pc)).ist = (((u32)(0U)) | _const_regex__ist_group_start);
			(*(regex__Token*)array_get(re->prog, pc)).rep_min = 1;
			(*(regex__Token*)array_get(re->prog, pc)).rep_max = 1;
			if (negate_flag == true) {
				(*(regex__Token*)array_get(re->prog, pc)).group_neg = true;
				(*(regex__Token*)array_get(re->prog, pc)).rep_min = 0;
			}
			if (cgroup_flag == false) {
				(*(regex__Token*)array_get(re->prog, pc)).group_id = -1;
			} else {
				(*(regex__Token*)array_get(re->prog, pc)).group_id = group_id;
			}
			pc = (int)(pc + 1);
			continue;
		}
		if (char_len == 1 && pc > 0 && ((u8)(char_tmp)) == ')') {
			if (group_stack_index < 0) {
				return (multi_return_int_int){.arg0=_const_regex__err_group_not_balanced, .arg1=(int)(i + 1)};
			}
			int goto_pc = (*(int*)array_get(group_stack, group_stack_index));
			group_stack_index--;
			(*(regex__Token*)array_get(re->prog, pc)).ist = (((u32)(0U)) | _const_regex__ist_group_end);
			(*(regex__Token*)array_get(re->prog, pc)).rep_min = 1;
			(*(regex__Token*)array_get(re->prog, pc)).rep_max = 1;
			(*(regex__Token*)array_get(re->prog, pc)).goto_pc = goto_pc;
			(*(regex__Token*)array_get(re->prog, pc)).group_id = (*(regex__Token*)array_get(re->prog, goto_pc)).group_id;
			(*(regex__Token*)array_get(re->prog, goto_pc)).goto_pc = pc;
			if ((*(regex__Token*)array_get(re->prog, goto_pc)).group_neg == true) {
				(*(regex__Token*)array_get(re->prog, pc)).group_neg = (*(regex__Token*)array_get(re->prog, goto_pc)).group_neg;
				(*(regex__Token*)array_get(re->prog, pc)).rep_min = (*(regex__Token*)array_get(re->prog, goto_pc)).rep_min;
			}
			pc = (int)(pc + 1);
			i = (int)(i + char_len);
			continue;
		...
		if (char_len == 1 && pc >= 0 && ((u8)(char_tmp)) == '.') {
			if (pc > 0 && (*(regex__Token*)array_get(re->prog, (int)(pc - 1))).ist == _const_regex__ist_dot_char) {
				return (multi_return_int_int){.arg0=_const_regex__err_consecutive_dots, .arg1=i};
			}
			(*(regex__Token*)array_get(re->prog, pc)).ist = (((u32)(0U)) | _const_regex__ist_dot_char);
			(*(regex__Token*)array_get(re->prog, pc)).rep_min = 1;
			(*(regex__Token*)array_get(re->prog, pc)).rep_max = 1;
			pc = (int)(pc + 1);
			i = (int)(i + char_len);
		...
		if (char_len == 1 && pc > 0 && ((u8)(char_tmp)) == '|') {
			if (pc > 0 && (*(regex__Token*)array_get(re->prog, (int)(pc - 1))).ist == _const_regex__ist_or_branch) {
				return (multi_return_int_int){.arg0=_const_regex__err_syntax_error, .arg1=i};
			}
			(*(regex__Token*)array_get(re->prog, pc)).ist = (((u32)(0U)) | _const_regex__ist_or_branch);
			(*(regex__Token*)array_get(re->prog, pc)).source_index = i;
			pc = (int)(pc + 1);
			i = (int)(i + char_len);
			continue;
		}
		if (char_len == 1 && pc > 0) {
			rune char_next = ((rune)(0));
			int char_next_len = 0;
			if (((int)(char_len + i)) < in_txt.len) {
				multi_return_u32_int mr_26436 = regex__RE_get_char(/*rec*/*re, in_txt, (int)(i + char_len));
				char_next = mr_26436.arg0;
				char_next_len = mr_26436.arg1;
			}
			bool quant_flag = true;
			if ((*(regex__Token*)array_get(re->prog, (int)(pc - 1))).group_neg == true && (char_tmp == '?' || char_tmp == '+' || char_tmp == '*' || char_tmp == '{')) {
				return (multi_return_int_int){.arg0=_const_regex__err_neg_group_quantifier, .arg1=i};
			}
			u8 /*A*/ _t8 = ((u8)(char_tmp));
			
			if (_t8 == ('?')) {
				if (char_next_len == 1 && (Array_rune_contains(_const_regex__quntifier_chars, char_next))) {
					return (multi_return_int_int){.arg0=_const_regex__err_syntax_error, .arg1=i};
				}
				(*(regex__Token*)array_get(re->prog, (int)(pc - 1))).rep_min = 0;
				(*(regex__Token*)array_get(re->prog, (int)(pc - 1))).rep_max = 1;
			}
			else if (_t8 == ('+')) {
				if (char_next_len == 1 && (Array_rune_contains(_const_regex__quntifier_chars, char_next))) {
					return (multi_return_int_int){.arg0=_const_regex__err_syntax_error, .arg1=i};
				}
				(*(regex__Token*)array_get(re->prog, (int)(pc - 1))).rep_min = 1;
				(*(regex__Token*)array_get(re->prog, (int)(pc - 1))).rep_max = _const_regex__max_quantifier;
			}
			else if (_t8 == ('*')) {
				if (char_next_len == 1 && (Array_rune_contains(_const_regex__quntifier_chars, char_next))) {
					return (multi_return_int_int){.arg0=_const_regex__err_syntax_error, .arg1=i};
				...
				multi_return_int_int_int_bool mr_27601 = regex__RE_parse_quantifier(re, in_txt, (int)(i + 1));
				int min = mr_27601.arg0;
				int max = mr_27601.arg1;
				int tmp = mr_27601.arg2;
				bool greedy = mr_27601.arg3;
				if (min >= 0) {
					i = (int)(i + tmp);
					(*(regex__Token*)array_get(re->prog, (int)(pc - 1))).rep_min = min;
					(*(regex__Token*)array_get(re->prog, (int)(pc - 1))).rep_max = max;
					(*(regex__Token*)array_get(re->prog, (int)(pc - 1))).greedy = greedy;
					if (i <= in_txt.len) {
						multi_return_u32_int mr_27991 = regex__RE_get_char(/*rec*/*re, in_txt, i);
						char_next = mr_27991.arg0;
						char_next_len = mr_27991.arg1;
						if (char_next_len == 1 && (Array_rune_contains(_const_regex__quntifier_chars, char_next))) {
							return (multi_return_int_int){.arg0=_const_regex__err_syntax_error, .arg1=i};
						}
					}
					...
					return (multi_return_int_int){.arg0=min, .arg1=i};
				}
			}
			else {
				quant_flag = false;
		...
		if (char_len == 1 && pc >= 0) {
			if (((u8)(char_tmp)) == '[') {
				multi_return_int_int_u32 mr_28608 = regex__RE_parse_char_class(re, in_txt, (int)(i + 1));
				int cc_index = mr_28608.arg0;
				int tmp = mr_28608.arg1;
				u32 cc_type = mr_28608.arg2;
				if (cc_index >= 0) {
					i = (int)(i + tmp);
					(*(regex__Token*)array_get(re->prog, pc)).ist = (((u32)(0U)) | cc_type);
					(*(regex__Token*)array_get(re->prog, pc)).cc_index = cc_index;
					(*(regex__Token*)array_get(re->prog, pc)).rep_min = 1;
					(*(regex__Token*)array_get(re->prog, pc)).rep_max = 1;
					pc = (int)(pc + 1);
					continue;
				} else if (cc_index < 0) {
					return (multi_return_int_int){.arg0=cc_index, .arg1=i};
				}
			}
		}
		if (char_len == 1 && pc >= 0) {
			if (((u8)(char_tmp)) == '\\') {
				multi_return_int_int mr_29120 = regex__RE_parse_bsls(re, in_txt, i);
				int bsls_index = mr_29120.arg0;
				int tmp = mr_29120.arg1;
				if (bsls_index >= 0) {
					i = (int)(i + tmp);
					(*(regex__Token*)array_get(re->prog, pc)).ist = (((u32)(0U)) | _const_regex__ist_bsls_char);
					(*(regex__Token*)array_get(re->prog, pc)).rep_min = 1;
					(*(regex__Token*)array_get(re->prog, pc)).rep_max = 1;
					(*(regex__Token*)array_get(re->prog, pc)).validator = (voidptr)(*(regex__BslsStruct*)array_get(_const_regex__bsls_validator_array, bsls_index)).validator;
					(*(regex__Token*)array_get(re->prog, pc)).ch = (*(regex__BslsStruct*)array_get(_const_regex__bsls_validator_array, bsls_index)).ch;
					pc = (int)(pc + 1);
					continue;
				} else if (bsls_index == _const_regex__no_match_found) {
					i += char_len;
					multi_return_u32_int mr_29707 = regex__RE_get_char(/*rec*/*re, in_txt, i);
					char_tmp = mr_29707.arg0;
					char_len = mr_29707.arg1;
				} else {
					return (multi_return_int_int){.arg0=bsls_index, .arg1=(int)(i + tmp)};
				}
			}
		}
		(*(regex__Token*)array_get(re->prog, pc)).ist = _const_regex__ist_simple_char;
		(*(regex__Token*)array_get(re->prog, pc)).ch = char_tmp;
		(*(regex__Token*)array_get(re->prog, pc)).ch_len = ((u8)(char_len));
		(*(regex__Token*)array_get(re->prog, pc)).rep_min = 1;
		(*(regex__Token*)array_get(re->prog, pc)).rep_max = 1;
		pc = (int)(pc + 1);
		i += char_len;
	}
	(*(regex__Token*)array_get(re->prog, pc)).ist = _const_regex__ist_prog_end;
	re->prog_len = pc;
	if (group_stack_index != -1) {
		return (multi_return_int_int){.arg0=_const_regex__err_group_not_balanced, .arg1=(int)((*(int*)array_get(group_stack_txt_index, group_stack_index)) + 1)};
	}
	if (pc > 0 && (*(regex__Token*)array_get(re->prog, (int)(pc - 1))).ist == _const_regex__ist_or_branch) {
		return (multi_return_int_int){.arg0=_const_regex__err_syntax_error, .arg1=(int)(in_txt.len - 1)};
	}
	re->group_count = (int)(group_count + 1);
	int pc1 = 0;
	int dot_char_count = 0;
	int last_dot_char_pc = -1;
	for (;;) {
		if (!(pc1 < pc)) break;
		if ((*(regex__Token*)array_get(re->prog, pc1)).ist == _const_regex__ist_dot_char) {
			last_dot_char_pc = pc1;
			dot_char_count++;
			int pc2 = (int)(pc1 + 1);
			for (;;) {
				if (!(pc2 < pc)) break;
				if ((*(regex__Token*)array_get(re->prog, pc2)).ist == _const_regex__ist_dot_char) {
					return (multi_return_int_int){.arg0=_const_regex__err_syntax_error, .arg1=0};
				}
				if (!((*(regex__Token*)array_get(re->prog, pc2)).ist == ((u32)(_const_regex__ist_prog_end)) || (*(regex__Token*)array_get(re->prog, pc2)).ist == _const_regex__ist_group_end || (*(regex__Token*)array_get(re->prog, pc2)).ist == _const_regex__ist_group_start)) {
					(*(regex__Token*)array_get(re->prog, pc1)).dot_check_pc = pc2;
					break;
				}
				pc2++;
			}
	...
	if (last_dot_char_pc >= 0) {
		pc1 = (int)(last_dot_char_pc + 1);
		bool is_last_dot = true;
		for (;;) {
			if (!(pc1 < pc)) break;
			if (!((*(regex__Token*)array_get(re->prog, pc1)).ist == ((u32)(_const_regex__ist_prog_end)) || (*(regex__Token*)array_get(re->prog, pc1)).ist == _const_regex__ist_group_end)) {
				is_last_dot = false;
				break;
			}
			pc1++;
		...
		if (is_last_dot) {
			(*(regex__Token*)array_get(re->prog, last_dot_char_pc)).last_dot_flag = true;
		}
	}
	pc1 = 0;
	int bsls_char_count = 0;
	int last_bsls_char_pc = -1;
	for (;;) {
		if (!(pc1 < pc)) break;
		if ((*(regex__Token*)array_get(re->prog, pc1)).ist == _const_regex__ist_bsls_char) {
			...
			for (;;) {
				if (!(pc2 < pc)) break;
				if (!((*(regex__Token*)array_get(re->prog, pc2)).ist == ((u32)(_const_regex__ist_prog_end)) || (*(regex__Token*)array_get(re->prog, pc2)).ist == _const_regex__ist_group_end || (*(regex__Token*)array_get(re->prog, pc2)).ist == _const_regex__ist_group_start)) {
					(*(regex__Token*)array_get(re->prog, pc1)).bsls_check_pc = pc2;
					break;
				}
				pc2++;
			}
	...
	if (last_bsls_char_pc >= 0) {
		pc1 = (int)(last_bsls_char_pc + 1);
		bool is_last_bsls = true;
		for (;;) {
			if (!(pc1 < pc)) break;
			if (!((*(regex__Token*)array_get(re->prog, pc1)).ist == ((u32)(_const_regex__ist_prog_end)) || (*(regex__Token*)array_get(re->prog, pc1)).ist == _const_regex__ist_group_end)) {
				is_last_bsls = false;
		...
		if (is_last_bsls) {
			(*(regex__Token*)array_get(re->prog, last_bsls_char_pc)).last_dot_flag = true;
		}
	}
	pc1 = 0;
	int cc_char_count = 0;
	int last_cc_char_pc = -1;
	for (;;) {
		if (!(pc1 < pc)) break;
		if ((*(regex__Token*)array_get(re->prog, pc1)).ist == ((u32)(_const_regex__ist_char_class_pos)) || (*(regex__Token*)array_get(re->prog, pc1)).ist == _const_regex__ist_char_class_neg) {
			last_cc_char_pc = pc1;
			cc_char_count++;
			int pc2 = (int)(pc1 + 1);
			for (;;) {
				if (!(pc2 < pc)) break;
				if (!((*(regex__Token*)array_get(re->prog, pc2)).ist == ((u32)(_const_regex__ist_prog_end)) || (*(regex__Token*)array_get(re->prog, pc2)).ist == _const_regex__ist_group_end || (*(regex__Token*)array_get(re->prog, pc2)).ist == _const_regex__ist_group_start)) {
					(*(regex__Token*)array_get(re->prog, pc1)).cc_check_pc = pc2;
					break;
				}
				pc2++;
			}
	...
	if (last_cc_char_pc >= 0) {
		pc1 = (int)(last_cc_char_pc + 1);
		bool is_last_cc = true;
		for (;;) {
			if (!(pc1 < pc)) break;
			if (!((*(regex__Token*)array_get(re->prog, pc1)).ist == ((u32)(_const_regex__ist_prog_end)) || (*(regex__Token*)array_get(re->prog, pc1)).ist == _const_regex__ist_group_end)) {
				is_last_cc = false;
		...
		if (is_last_cc) {
			(*(regex__Token*)array_get(re->prog, last_cc_char_pc)).last_dot_flag = true;
		}
	}
	pc1 = 0;
	for (;;) {
		if (!(pc1 < (int)(pc - 2))) break;
		if ((*(regex__Token*)array_get(re->prog, (int)(pc1 + 1))).ist == _const_regex__ist_or_branch) {
			if ((*(regex__Token*)array_get(re->prog, (int)(pc1 + 2))).ist == _const_regex__ist_or_branch) {
				return (multi_return_int_int){.arg0=_const_regex__err_syntax_error, .arg1=i};
			}
			if ((*(regex__Token*)array_get(re->prog, pc1)).ist == _const_regex__ist_char_class_pos && (*(regex__Token*)array_get(re->prog, (int)(pc1 + 2))).ist == _const_regex__ist_char_class_pos) {
				return (multi_return_int_int){.arg0=_const_regex__err_invalid_or_with_cc, .arg1=(*(regex__Token*)array_get(re->prog, (int)(pc1 + 1))).source_index};
			}
		}
		if ((*(regex__Token*)array_get(re->prog, pc1)).ist != _const_regex__ist_or_branch && (*(regex__Token*)array_get(re->prog, (int)(pc1 + 1))).ist == _const_regex__ist_or_branch && (*(regex__Token*)array_get(re->prog, (int)(pc1 + 2))).ist != _const_regex__ist_or_branch) {
			(*(regex__Token*)array_get(re->prog, pc1)).next_is_or = true;
			(*(regex__Token*)array_get(re->prog, (int)(pc1 + 1))).rep_min = (int)(pc1 + 2);
			int pc2 = (int)(pc1 + 2);
			for (;;) {
				if (!(pc2 < (int)(pc - 1))) break;
				u32 ist = (*(regex__Token*)array_get(re->prog, pc2)).ist;
				if (ist == _const_regex__ist_group_start) {
					(*(regex__Token*)array_get(re->prog, (int)(pc1 + 1))).rep_max = (int)((*(regex__Token*)array_get(re->prog, pc2)).goto_pc + 1);
					break;
				}
				if (ist != _const_regex__ist_or_branch) {
					(*(regex__Token*)array_get(re->prog, (int)(pc1 + 1))).rep_max = (int)(pc2 + 1);
					break;
				}
				pc2++;
			}
			if ((*(regex__Token*)array_get(re->prog, (int)(pc1 + 1))).rep_max == pc1) {
				(*(regex__Token*)array_get(re->prog, (int)(pc1 + 1))).rep_max = 3;
			}
			pc1 = pc2;
			continue;
		}
	...
	if (re->debug > 0) {
		string gc = regex__RE_get_code(re);
		re->log_func(gc);
	}
	return (multi_return_int_int){.arg0=_const_regex__compile_ok, .arg1=0};
}

string regex__RE_get_code(regex__RE* re) {
	int pc1 = 0;
	strings__Builder res = strings__new_builder((int)((int)(re->cc.len * 2) * re->prog.len));
	strings__Builder_write_string(&res,  str_intp(2, _MOV((StrIntpData[]){{_SLIT("========================================\nv RegEx compiler v "), 0xfe10, {.d_s = _const_regex__v_regex_version}}, {_SLIT(" output:\n"), 0, { .d_c = 0 }}})));
	bool stop_flag = false;
	for (;;) {
		if (!(pc1 <= re->prog.len)) break;
		regex__Token tk = (*(regex__Token*)array_get(re->prog, pc1));
		strings__Builder_write_string(&res,  str_intp(2, _MOV((StrIntpData[]){{_SLIT("PC:"), 0x6fe27, {.d_i32 = pc1}}, {_SLIT0, 0, { .d_c = 0 }}})));
		strings__Builder_write_string(&res, _SLIT(" ist: "));
		strings__Builder_write_string(&res, string_replace( str_intp(2, _MOV((StrIntpData[]){{_SLIT0, 0x7010fe26, {.d_u32 = tk.ist}}, {_SLIT0, 0, { .d_c = 0 }}})), _SLIT(" "), _SLIT("0")));
		strings__Builder_write_string(&res, _SLIT(" "));
		u32 ist = tk.ist;
		if (ist == _const_regex__ist_bsls_char) {
			strings__Builder_write_string(&res,  str_intp(2, _MOV((StrIntpData[]){{_SLIT("[\\"), 0x2fe21, {.d_c = tk.ch}}, {_SLIT("]     BSLS"), 0, { .d_c = 0 }}})));
			if (tk.last_dot_flag == true) {
				strings__Builder_write_string(&res, _SLIT(" last!"));
			}
		} else if (ist == _const_regex__ist_prog_end) {
			strings__Builder_write_string(&res, _SLIT("PROG_END"));
			stop_flag = true;
		} else if (ist == _const_regex__ist_or_branch) {
			strings__Builder_write_string(&res, _SLIT("OR      "));
		} else if (ist == _const_regex__ist_char_class_pos) {
			strings__Builder_write_string(&res,  str_intp(2, _MOV((StrIntpData[]){{_SLIT("["), 0xfe10, {.d_s = regex__RE_get_char_class(re, pc1)}}, {_SLIT("]     CHAR_CLASS_POS"), 0, { .d_c = 0 }}})));
			if (tk.last_dot_flag == true) {
				strings__Builder_write_string(&res, _SLIT(" last!"));
			}
		} else if (ist == _const_regex__ist_char_class_neg) {
			strings__Builder_write_string(&res,  str_intp(2, _MOV((StrIntpData[]){{_SLIT("[^"), 0xfe10, {.d_s = regex__RE_get_char_class(re, pc1)}}, {_SLIT("]    CHAR_CLASS_NEG"), 0, { .d_c = 0 }}})));
			if (tk.last_dot_flag == true) {
				strings__Builder_write_string(&res, _SLIT(" last!"));
			}
		} else if (ist == _const_regex__ist_dot_char) {
			strings__Builder_write_string(&res,  str_intp(2, _MOV((StrIntpData[]){{_SLIT(".        DOT_CHAR nx chk: "), 0xfe07, {.d_i32 = tk.dot_check_pc}}, {_SLIT0, 0, { .d_c = 0 }}})));
			if (tk.last_dot_flag == true) {
				strings__Builder_write_string(&res, _SLIT(" last!"));
			}
		} else if (ist == _const_regex__ist_group_start) {
			strings__Builder_write_string(&res,  str_intp(2, _MOV((StrIntpData[]){{_SLIT("(        GROUP_START #:"), 0xfe07, {.d_i32 = tk.group_id}}, {_SLIT0, 0, { .d_c = 0 }}})));
			if (tk.group_id == -1) {
				strings__Builder_write_string(&res, _SLIT(" ?:"));
			} else {
				Array_string _t1 = map_keys(&re->group_map);
				for (int _t2 = 0; _t2 < _t1.len; ++_t2) {
					string x = ((string*)_t1.data)[_t2];
					if ((*(int*)map_get(ADDR(map, re->group_map), &(string[]){x}, &(int[]){ 0 })) == ((int)(tk.group_id + 1))) {
						strings__Builder_write_string(&res,  str_intp(2, _MOV((StrIntpData[]){{_SLIT(" ?P<"), 0xfe10, {.d_s = x}}, {_SLIT(">"), 0, { .d_c = 0 }}})));
						break;
					}
				}
			}
		} else if (ist == _const_regex__ist_group_end) {
			strings__Builder_write_string(&res,  str_intp(2, _MOV((StrIntpData[]){{_SLIT(")        GROUP_END   #:"), 0xfe07, {.d_i32 = tk.group_id}}, {_SLIT0, 0, { .d_c = 0 }}})));
		} else if (ist == _const_regex__ist_simple_char) {
			strings__Builder_write_string(&res,  str_intp(2, _MOV((StrIntpData[]){{_SLIT("["), 0x2fe21, {.d_c = tk.ch}}, {_SLIT("]      query_ch"), 0, { .d_c = 0 }}})));
		}
		if (tk.rep_max == _const_regex__max_quantifier) {
			strings__Builder_write_string(&res,  str_intp(2, _MOV((StrIntpData[]){{_SLIT(" {"), 0x6fe27, {.d_i32 = tk.rep_min}}, {_SLIT(",MAX}"), 0, { .d_c = 0 }}})));
		} else {
			if (ist == _const_regex__ist_or_branch) {
				strings__Builder_write_string(&res,  str_intp(3, _MOV((StrIntpData[]){{_SLIT(" if false go: "), 0x6fe27, {.d_i32 = tk.rep_min}}, {_SLIT(" if true go: "), 0x6fe27, {.d_i32 = tk.rep_max}}, {_SLIT0, 0, { .d_c = 0 }}})));
			} else {
				strings__Builder_write_string(&res,  str_intp(3, _MOV((StrIntpData[]){{_SLIT(" {"), 0x6fe27, {.d_i32 = tk.rep_min}}, {_SLIT(","), 0x6fe27, {.d_i32 = tk.rep_max}}, {_SLIT("}"), 0, { .d_c = 0 }}})));
			}
			if (tk.greedy == true) {
				strings__Builder_write_string(&res, _SLIT("?"));
			}
...
string regex__RE_get_query(regex__RE* re) {
	strings__Builder res = strings__new_builder((int)(re->query.len * 2));
	if (((re->flag & _const_regex__f_ms)) != 0) {
		strings__Builder_write_string(&res, _SLIT("^"));
	}
	int i = 0;
	for (;;) {
		if (!(i < re->prog.len && (*(regex__Token*)array_get(re->prog, i)).ist != _const_regex__ist_prog_end && (*(regex__Token*)array_get(re->prog, i)).ist != 0U)) break;
		regex__Token* tk = &(*(regex__Token*)array_get(re->prog, i));
		u32 ch = tk->ist;
		if (ch == _const_regex__ist_group_start) {
			if (re->debug > 0) {
				strings__Builder_write_string(&res,  str_intp(2, _MOV((StrIntpData[]){{_SLIT("#"), 0xfe07, {.d_i32 = tk->group_id}}, {_SLIT0, 0, { .d_c = 0 }}})));
			}
			strings__Builder_write_string(&res, _SLIT("("));
		...
		if (ch == _const_regex__ist_group_end) {
			strings__Builder_write_string(&res, _SLIT(")"));
		}
		if (ch == _const_regex__ist_or_branch) {
			strings__Builder_write_string(&res, _SLIT("|"));
			if (re->debug > 0) {
				strings__Builder_write_string(&res,  str_intp(3, _MOV((StrIntpData[]){{_SLIT("{"), 0xfe07, {.d_i32 = tk->rep_min}}, {_SLIT(","), 0xfe07, {.d_i32 = tk->rep_max}}, {_SLIT("}"), 0, { .d_c = 0 }}})));
			}
			i++;
			continue;
		}
		if (ch == _const_regex__ist_char_class_neg || ch == _const_regex__ist_char_class_pos) {
			strings__Builder_write_string(&res, _SLIT("["));
			if (ch == _const_regex__ist_char_class_neg) {
				strings__Builder_write_string(&res, _SLIT("^"));
			}
			strings__Builder_write_string(&res,  str_intp(2, _MOV((StrIntpData[]){{_SLIT0, 0xfe10, {.d_s = regex__RE_get_char_class(re, i)}}, {_SLIT0, 0, { .d_c = 0 }}})));
			strings__Builder_write_string(&res, _SLIT("]"));
		}
		if (ch == _const_regex__ist_bsls_char) {
			strings__Builder_write_string(&res,  str_intp(2, _MOV((StrIntpData[]){{_SLIT("\\"), 0x2fe21, {.d_c = tk->ch}}, {_SLIT0, 0, { .d_c = 0 }}})));
		}
		if (ch == _const_regex__ist_dot_char) {
			strings__Builder_write_string(&res, _SLIT("."));
		}
		if (ch == _const_regex__ist_simple_char) {
			if ((Array_rune_contains(_const_regex__bsls_escape_list, ((u8)(ch))))) {
				strings__Builder_write_string(&res, _SLIT("\\"));
			}
			strings__Builder_write_string(&res,  str_intp(2, _MOV((StrIntpData[]){{_SLIT0, 0xfe01, {.d_c = tk->ch}}, {_SLIT0, 0, { .d_c = 0 }}})));
		}
		if (!(tk->rep_min == 1 && tk->rep_max == 1) && tk->group_neg == false) {
			if (tk->rep_min == 0 && tk->rep_max == 1) {
				strings__Builder_write_string(&res, _SLIT("?"));
			} else if (tk->rep_min == 1 && tk->rep_max == _const_regex__max_quantifier) {
				strings__Builder_write_string(&res, _SLIT("+"));
			} else if (tk->rep_min == 0 && tk->rep_max == _const_regex__max_quantifier) {
				strings__Builder_write_string(&res, _SLIT("*"));
			} else {
				if (tk->rep_max == _const_regex__max_quantifier) {
					strings__Builder_write_string(&res,  str_intp(2, _MOV((StrIntpData[]){{_SLIT("{"), 0xfe07, {.d_i32 = tk->rep_min}}, {_SLIT(",MAX}"), 0, { .d_c = 0 }}})));
				} else {
					strings__Builder_write_string(&res,  str_intp(3, _MOV((StrIntpData[]){{_SLIT("{"), 0xfe07, {.d_i32 = tk->rep_min}}, {_SLIT(","), 0xfe07, {.d_i32 = tk->rep_max}}, {_SLIT("}"), 0, { .d_c = 0 }}})));
				}
				if (tk->greedy == true) {
	...
	if (((re->flag & _const_regex__f_me)) != 0) {
		strings__Builder_write_string(&res, _SLIT("$"));
	}
	string _t3 = strings__Builder_str(&res);
	return _t3;
...
VV_LOCAL_SYMBOL void regex__RE_group_continuous_save(regex__RE* re, int g_index) {
	if (re->group_csave_flag == true) {
		if (re->group_csave.len == 0) {
			array_push_noscan((array*)&re->group_csave, _MOV((int[]){ 0 }));
		}
		int gi = (g_index >> 1);
		int start = ((int*)re->groups.data)[g_index];
		int end = ((int*)re->groups.data)[(int)(g_index + 1)];
		if (re->group_csave.len >= 4 && gi == ((int*)re->group_csave.data)[(int)(re->group_csave.len - 3)] && start == ((int*)re->group_csave.data)[(int)(re->group_csave.len - 2)]) {
			((int*)re->group_csave.data)[(int)(re->group_csave.len - 1)] = end;
			return;
		}
		((int*)re->group_csave.data)[0]++;
		array_push_noscan((array*)&re->group_csave, _MOV((int[]){ ((g_index >> 1)) }));
		array_push_noscan((array*)&re->group_csave, _MOV((int[]){ ((int*)re->groups.data)[g_index] }));
		array_push_noscan((array*)&re->group_csave, _MOV((int[]){ ((int*)re->groups.data)[(int)(g_index + 1)] }));
	}
}

VV_LOCAL_SYMBOL string regex__state_str(regex__Match_state s) {
	switch (s) {
		case regex__Match_state__start: {
				string _t1 = _SLIT("start");
				return _t1;
		}
		case regex__Match_state__stop: {
				string _t2 = _SLIT("stop");
				return _t2;
		}
		case regex__Match_state__end: {
				string _t3 = _SLIT("end");
				return _t3;
		}
		case regex__Match_state__new_line: {
				string _t4 = _SLIT("new line");
				return _t4;
		}
		case regex__Match_state__ist_load: {
				string _t5 = _SLIT("ist_load");
				return _t5;
		}
		case regex__Match_state__ist_next: {
				string _t6 = _SLIT("ist_next");
				return _t6;
		}
		case regex__Match_state__ist_next_ks: {
				string _t7 = _SLIT("ist_next_ks");
				return _t7;
		}
		case regex__Match_state__ist_quant_p: {
				string _t8 = _SLIT("ist_quant_p");
				return _t8;
		}
		case regex__Match_state__ist_quant_n: {
				string _t9 = _SLIT("ist_quant_n");
				return _t9;
		}
		case regex__Match_state__ist_quant_pg: {
				string _t10 = _SLIT("ist_quant_pg");
				return _t10;
		}
		case regex__Match_state__ist_quant_ng: {
				string _t11 = _SLIT("ist_quant_ng");
				return _t11;
		}
	}
...
// Attr: [direct_array_access]
multi_return_int_int regex__RE_match_base(regex__RE* re, u8* in_txt, int in_txt_len) {
	int result = _const_regex__no_match_found;
	rune ch = ((rune)(0));
	int char_len = 0;
	regex__Match_state m_state = regex__Match_state__start;
	bool src_end = false;
	int last_fnd_pc = -1;
	regex__StateObj state = ((regex__StateObj){.group_index = -1,.match_flag = 0,.match_index = -1,.first_match = -1,.pc = -1,.i = -1,.char_len = 0,.last_dot_pc = -1,});
	u32 ist = ((u32)(0U));
	u32 l_ist = ((u32)(0U));
	int step_count = 0;
	int dbg_line = 0;
	regex__RE_reset(re);
	if (re->debug > 0) {
		strings__Builder h_buf = strings__new_builder(32);
		strings__Builder_write_string(&h_buf, _SLIT("flags: "));
		strings__Builder_write_string(&h_buf, string_replace( str_intp(2, _MOV((StrIntpData[]){{_SLIT0, 0x7010fe27, {.d_i32 = (u32)(re->flag)}}, {_SLIT0, 0, { .d_c = 0 }}})), _SLIT(" "), _SLIT("0")));
		strings__Builder_write_string(&h_buf, _SLIT("\n"));
		string sss = strings__Builder_str(&h_buf);
		re->log_func(sss);
	}
	for (;;) {
		if (!(m_state != regex__Match_state__end)) break;
		if (state.pc >= 0 && state.pc < re->prog.len) {
			ist = ((regex__Token*)re->prog.data)[state.pc].ist;
		} else if (state.pc >= re->prog.len) {
			return (multi_return_int_int){.arg0=_const_regex__err_internal_error, .arg1=state.i};
		}
		if (re->debug > 0) {
			strings__Builder buf2 = strings__new_builder((int)(re->cc.len + 128));
			if (state.i >= in_txt_len) {
				strings__Builder_write_string(&buf2,  str_intp(2, _MOV((StrIntpData[]){{_SLIT("# "), 0x6fe27, {.d_i32 = step_count}}, {_SLIT(" END OF INPUT TEXT\n"), 0, { .d_c = 0 }}})));
				string sss = strings__Builder_str(&buf2);
				re->log_func(sss);
			} else {
				if ((re->debug == 1 && m_state == regex__Match_state__ist_load) || re->debug == 2) {
					if (ist == _const_regex__ist_prog_end) {
						strings__Builder_write_string(&buf2,  str_intp(2, _MOV((StrIntpData[]){{_SLIT("# "), 0x6fe27, {.d_i32 = step_count}}, {_SLIT(" PROG_END\n"), 0, { .d_c = 0 }}})));
					} else if (ist == 0U || (m_state == regex__Match_state__start || m_state == regex__Match_state__ist_next || m_state == regex__Match_state__stop)) {
						strings__Builder_write_string(&buf2,  str_intp(3, _MOV((StrIntpData[]){{_SLIT("# "), 0x6fe27, {.d_i32 = step_count}}, {_SLIT(" s: "), 0x18fe30, {.d_s = regex__state_str(m_state)}}, {_SLIT(" PC: NA\n"), 0, { .d_c = 0 }}})));
					} else {
						multi_return_u32_int mr_44692 = regex__RE_get_charb(/*rec*/*re, in_txt, state.i);
						ch = mr_44692.arg0;
						char_len = mr_44692.arg1;
						strings__Builder_write_string(&buf2,  str_intp(4, _MOV((StrIntpData[]){{_SLIT("# "), 0x6fe27, {.d_i32 = step_count}}, {_SLIT(" s: "), 0x18fe30, {.d_s = regex__state_str(m_state)}}, {_SLIT(" PC: "), 0x6fe27, {.d_i32 = state.pc}}, {_SLIT("=>"), 0, { .d_c = 0 }}})));
						strings__Builder_write_string(&buf2, string_replace( str_intp(2, _MOV((StrIntpData[]){{_SLIT0, 0x7010fe26, {.d_u32 = ist}}, {_SLIT0, 0, { .d_c = 0 }}})), _SLIT(" "), _SLIT("0")));
						strings__Builder_write_string(&buf2,  str_intp(6, _MOV((StrIntpData[]){{_SLIT(" i,ch,len:["), 0x6fe27, {.d_i32 = state.i}}, {_SLIT(",'"), 0xfe10, {.d_s = regex__utf8_str(ch)}}, {_SLIT("',"), 0xfe07, {.d_i32 = char_len}}, {_SLIT("] f.m:["), 0x6fe27, {.d_i32 = state.first_match}}, {_SLIT(","), 0x6fe27, {.d_i32 = state.match_index}}, {_SLIT("] "), 0, { .d_c = 0 }}})));
						if (ist == _const_regex__ist_simple_char) {
							strings__Builder_write_string(&buf2,  str_intp(2, _MOV((StrIntpData[]){{_SLIT("query_ch: ["), 0x2fe21, {.d_c = ((regex__Token*)re->prog.data)[state.pc].ch}}, {_SLIT("]"), 0, { .d_c = 0 }}})));
						} else {
							if (ist == _const_regex__ist_bsls_char) {
								strings__Builder_write_string(&buf2,  str_intp(2, _MOV((StrIntpData[]){{_SLIT("BSLS [\\"), 0x2fe21, {.d_c = ((regex__Token*)re->prog.data)[state.pc].ch}}, {_SLIT("]"), 0, { .d_c = 0 }}})));
							} else if (ist == _const_regex__ist_prog_end) {
								strings__Builder_write_string(&buf2, _SLIT("PROG_END"));
							} else if (ist == _const_regex__ist_or_branch) {
								strings__Builder_write_string(&buf2, _SLIT("OR"));
							} else if (ist == _const_regex__ist_char_class_pos) {
								strings__Builder_write_string(&buf2,  str_intp(2, _MOV((StrIntpData[]){{_SLIT("CHAR_CLASS_POS["), 0xfe10, {.d_s = regex__RE_get_char_class(re, state.pc)}}, {_SLIT("]"), 0, { .d_c = 0 }}})));
							} else if (ist == _const_regex__ist_char_class_neg) {
								strings__Builder_write_string(&buf2,  str_intp(2, _MOV((StrIntpData[]){{_SLIT("CHAR_CLASS_NEG["), 0xfe10, {.d_s = regex__RE_get_char_class(re, state.pc)}}, {_SLIT("]"), 0, { .d_c = 0 }}})));
							} else if (ist == _const_regex__ist_dot_char) {
								strings__Builder_write_string(&buf2, _SLIT("DOT_CHAR"));
							} else if (ist == _const_regex__ist_group_start) {
								int tmp_gi = ((regex__Token*)re->prog.data)[state.pc].group_id;
								int tmp_gr = ((regex__Token*)re->prog.data)[((regex__Token*)re->prog.data)[state.pc].goto_pc].group_rep;
								strings__Builder_write_string(&buf2,  str_intp(3, _MOV((StrIntpData[]){{_SLIT("GROUP_START #:"), 0xfe07, {.d_i32 = tmp_gi}}, {_SLIT(" rep:"), 0xfe07, {.d_i32 = tmp_gr}}, {_SLIT(" "), 0, { .d_c = 0 }}})));
							} else if (ist == _const_regex__ist_group_end) {
								strings__Builder_write_string(&buf2,  str_intp(3, _MOV((StrIntpData[]){{_SLIT("GROUP_END   #:"), 0xfe07, {.d_i32 = ((regex__Token*)re->prog.data)[state.pc].group_id}}, {_SLIT(" deep:"), 0xfe07, {.d_i32 = state.group_index}}, {_SLIT0, 0, { .d_c = 0 }}})));
							}
						}
						if (((regex__Token*)re->prog.data)[state.pc].rep_max == _const_regex__max_quantifier) {
							strings__Builder_write_string(&buf2,  str_intp(3, _MOV((StrIntpData[]){{_SLIT("{"), 0xfe07, {.d_i32 = ((regex__Token*)re->prog.data)[state.pc].rep_min}}, {_SLIT(",MAX}:"), 0xfe07, {.d_i32 = ((regex__Token*)re->prog.data)[state.pc].rep}}, {_SLIT0, 0, { .d_c = 0 }}})));
						} else {
							strings__Builder_write_string(&buf2,  str_intp(4, _MOV((StrIntpData[]){{_SLIT("{"), 0xfe07, {.d_i32 = ((regex__Token*)re->prog.data)[state.pc].rep_min}}, {_SLIT(","), 0xfe07, {.d_i32 = ((regex__Token*)re->prog.data)[state.pc].rep_max}}, {_SLIT("}:"), 0xfe07, {.d_i32 = ((regex__Token*)re->prog.data)[state.pc].rep}}, {_SLIT0, 0, { .d_c = 0 }}})));
						}
						if (((regex__Token*)re->prog.data)[state.pc].greedy == true) {
							strings__Builder_write_string(&buf2, _SLIT("?"));
						}
						strings__Builder_write_string(&buf2,  str_intp(2, _MOV((StrIntpData[]){{_SLIT(" (#"), 0xfe07, {.d_i32 = state.group_index}}, {_SLIT(")"), 0, { .d_c = 0 }}})));
						if (ist == _const_regex__ist_dot_char) {
							strings__Builder_write_string(&buf2, _SLIT(" last!"));
						}
						strings__Builder_write_string(&buf2, _SLIT("\n"));
					}
					string sss2 = strings__Builder_str(&buf2);
					re->log_func(sss2);
				}
			}
			step_count++;
		...
		if (state.i >= in_txt_len || m_state == regex__Match_state__new_line) {
			src_end = true;
			if (state.i >= in_txt_len) {
				state.i = (int)(in_txt_len - 1);
			}
			if (state.group_index >= 0 && state.match_index >= 0) {
				for (;;) {
					if (!(state.group_index >= 0)) break;
					int tmp_pc = ((int*)re->group_data.data)[state.group_index];
					((regex__Token*)re->prog.data)[tmp_pc].group_rep++;
					if (((regex__Token*)re->prog.data)[tmp_pc].group_rep >= ((regex__Token*)re->prog.data)[tmp_pc].rep_min && ((regex__Token*)re->prog.data)[tmp_pc].group_id >= 0) {
						int start_i = ((int*)re->group_stack.data)[state.group_index];
						((int*)re->group_stack.data)[state.group_index] = -1;
						int g_index = (int)(((regex__Token*)re->prog.data)[tmp_pc].group_id * 2);
						if (start_i >= 0) {
							((int*)re->groups.data)[g_index] = start_i;
						} else {
							((int*)re->groups.data)[g_index] = 0;
						}
						((int*)re->groups.data)[(int)(g_index + 1)] = state.i;
						if (((int*)re->groups.data)[(int)(g_index + 1)] >= in_txt_len) {
							((int*)re->groups.data)[(int)(g_index + 1)] = (int)(in_txt_len - 1);
						}
						regex__RE_group_continuous_save(re, g_index);
					}
					state.group_index--;
				}
			}
			if (ist == _const_regex__ist_group_end && ((regex__Token*)re->prog.data)[(int)(state.pc + 1)].ist == _const_regex__ist_prog_end) {
				return (multi_return_int_int){.arg0=state.first_match, .arg1=state.i};
			}
			if (state.pc == -1) {
			...
			if (l_ist == ((u32)(_const_regex__ist_char_class_neg)) || l_ist == _const_regex__ist_char_class_pos || l_ist == _const_regex__ist_bsls_char || l_ist == _const_regex__ist_dot_char) {
				if (((regex__Token*)re->prog.data)[state.pc].last_dot_flag == true && ((regex__Token*)re->prog.data)[state.pc].rep >= ((regex__Token*)re->prog.data)[state.pc].rep_min && ((regex__Token*)re->prog.data)[state.pc].rep <= ((regex__Token*)re->prog.data)[state.pc].rep_max) {
					return (multi_return_int_int){.arg0=state.first_match, .arg1=state.i};
				}
			}
			if (ist != _const_regex__ist_group_end && ((regex__Token*)re->prog.data)[(int)(state.pc + 1)].ist == _const_regex__ist_prog_end) {
				if (((regex__Token*)re->prog.data)[state.pc].rep >= ((regex__Token*)re->prog.data)[state.pc].rep_min && ((regex__Token*)re->prog.data)[state.pc].rep <= ((regex__Token*)re->prog.data)[state.pc].rep_max) {
					return (multi_return_int_int){.arg0=state.first_match, .arg1=state.i};
				}
			}
			if (((regex__Token*)re->prog.data)[(int)(re->prog_len - 1)].ist == _const_regex__ist_group_end) {
				if (((regex__Token*)re->prog.data)[(int)(re->prog_len - 1)].group_rep >= ((regex__Token*)re->prog.data)[(int)(re->prog_len - 1)].rep_min) {
					return (multi_return_int_int){.arg0=state.first_match, .arg1=state.i};
				}
			}
			return (multi_return_int_int){.arg0=_const_regex__no_match_found, .arg1=state.i};
		}
		if (m_state == regex__Match_state__start) {
			state.pc = -1;
			state.i = 0;
			m_state = regex__Match_state__ist_next;
			continue;
		} else if (m_state == regex__Match_state__ist_next) {
			state.pc = (int)(state.pc + 1);
			regex__Token_reset(&((regex__Token*)re->prog.data)[state.pc]);
			if (state.pc < 0 || state.pc > re->prog.len) {
				return (multi_return_int_int){.arg0=_const_regex__err_internal_error, .arg1=state.i};
			}
			m_state = regex__Match_state__ist_load;
			continue;
		} else if (m_state == regex__Match_state__ist_next_ks) {
			state.pc = (int)(state.pc + 1);
			if (state.pc < 0 || state.pc > re->prog.len) {
				return (multi_return_int_int){.arg0=_const_regex__err_internal_error, .arg1=state.i};
			}
		...
		multi_return_u32_int mr_51304 = regex__RE_get_charb(/*rec*/*re, in_txt, state.i);
		ch = mr_51304.arg0;
		char_len = mr_51304.arg1;
		if (((re->flag & _const_regex__f_nl)) != 0 && char_len == 1 && (Array_rune_contains(_const_regex__new_line_list, ((u8)(ch))))) {
			m_state = regex__Match_state__new_line;
			continue;
		} else if (m_state == regex__Match_state__stop) {
			if (((re->flag & _const_regex__f_src)) != 0 && ist != _const_regex__ist_prog_end) {
				last_fnd_pc = state.pc;
				state.pc = -1;
				state.i += char_len;
				m_state = regex__Match_state__ist_next;
				regex__RE_reset_src(re);
				state.match_index = -1;
				state.first_match = -1;
				regex__RE_reset(re);
				continue;
			...
			if (re->state_list.len > 0) {
				state = (*(regex__StateObj*)array_pop_noscan(&re->state_list));
				state.match_flag = true;
				l_ist = ((u32)(_const_regex__ist_dot_char));
				if (state.first_match < 0) {
					state.first_match = state.i;
				}
				state.match_index = state.i;
				((regex__Token*)re->prog.data)[state.pc].rep++;
				state.i += char_len;
				m_state = regex__Match_state__ist_quant_p;
				continue;
			}
			return (multi_return_int_int){.arg0=result, .arg1=state.i};
		} else if (m_state == regex__Match_state__ist_load) {
			if (ist == _const_regex__ist_prog_end) {
				if (state.group_index >= 0 && state.match_index >= 0) {
					state.group_index = -1;
				}
				m_state = regex__Match_state__stop;
				continue;
			} else if (ist == _const_regex__ist_group_start) {
				state.group_index++;
				((int*)re->group_data.data)[state.group_index] = ((regex__Token*)re->prog.data)[state.pc].goto_pc;
				((int*)re->group_stack.data)[state.group_index] = state.i;
				m_state = regex__Match_state__ist_next;
				continue;
			} else if (ist == _const_regex__ist_group_end) {
				if (state.match_index >= 0) {
					if (state.group_index >= 0 && ((regex__Token*)re->prog.data)[state.pc].group_id >= 0) {
						int start_i = ((int*)re->group_stack.data)[state.group_index];
						int g_index = (int)(((regex__Token*)re->prog.data)[state.pc].group_id * 2);
						if (start_i >= 0) {
							((int*)re->groups.data)[g_index] = start_i;
						} else {
							((int*)re->groups.data)[g_index] = 0;
						...
						((int*)re->groups.data)[(int)(g_index + 1)] = state.i;
						if (g_index > 0 && ((int*)re->groups.data)[g_index] <= ((int*)re->groups.data)[(int)(g_index - 1)]) {
							((int*)re->groups.data)[g_index] = ((int*)re->groups.data)[(int)(g_index - 1)];
						}
						if (((int*)re->groups.data)[(int)(g_index + 1)] >= in_txt_len) {
							((int*)re->groups.data)[(int)(g_index + 1)] = (int)(in_txt_len - 1);
						}
					...
					((regex__Token*)re->prog.data)[state.pc].group_rep++;
					if (((regex__Token*)re->prog.data)[state.pc].group_rep > (int)(in_txt_len - 1)) {
						m_state = regex__Match_state__ist_quant_ng;
						continue;
					}
					m_state = regex__Match_state__ist_quant_pg;
					continue;
				}
				m_state = regex__Match_state__ist_quant_ng;
				continue;
				...
				if (state.match_index >= 0) {
					state.pc = ((regex__Token*)re->prog.data)[state.pc].rep_max;
				} else {
					state.pc = ((regex__Token*)re->prog.data)[state.pc].rep_min;
				}
				regex__Token_reset(&((regex__Token*)re->prog.data)[state.pc]);
				m_state = regex__Match_state__ist_load;
				continue;
			} else if (ist == _const_regex__ist_dot_char) {
				bool next_check_flag = false;
				if (((regex__Token*)re->prog.data)[state.pc].rep >= ((regex__Token*)re->prog.data)[state.pc].rep_max) {
					(*(regex__StateObj*)array_pop_noscan(&re->state_list));
					m_state = regex__Match_state__ist_next;
					continue;
				}
				if (((regex__Token*)re->prog.data)[state.pc].last_dot_flag == false && ((regex__Token*)re->prog.data)[state.pc].dot_check_pc >= 0 && ((regex__Token*)re->prog.data)[state.pc].rep >= ((regex__Token*)re->prog.data)[state.pc].rep_min) {
					rune ch_t = ch;
					int chk_pc = ((regex__Token*)re->prog.data)[state.pc].dot_check_pc;
					if (((regex__Token*)re->prog.data)[chk_pc].ist == _const_regex__ist_simple_char) {
						if (((regex__Token*)re->prog.data)[chk_pc].ch == ch_t) {
							next_check_flag = true;
						}
					} else if (((regex__Token*)re->prog.data)[chk_pc].ist == _const_regex__ist_char_class_pos || ((regex__Token*)re->prog.data)[chk_pc].ist == _const_regex__ist_char_class_neg) {
						bool cc_neg = false;
						if (((regex__Token*)re->prog.data)[chk_pc].ist == _const_regex__ist_char_class_neg) {
							cc_neg = true;
						}
						bool cc_res = regex__RE_check_char_class(re, chk_pc, ch_t);
						if (cc_neg) {
							cc_res = !cc_res;
						}
						next_check_flag = cc_res;
					} else if (((regex__Token*)re->prog.data)[chk_pc].ist == _const_regex__ist_bsls_char) {
						next_check_flag = ((regex__Token*)re->prog.data)[chk_pc].validator(((u8)(ch_t)));
					}
				}
				if (next_check_flag == true && ((regex__Token*)re->prog.data)[(int)(state.pc + 1)].ist != _const_regex__ist_prog_end) {
					regex__StateObj dot_state = ((regex__StateObj){
						.group_index = state.group_index,
						.match_flag = state.match_flag,
						.match_index = state.match_index,
						.first_match = state.first_match,
						.pc = state.pc,
						.i = (int)(state.i + char_len),
						.char_len = char_len,
						.last_dot_pc = state.pc,
					});
					if (((regex__Token*)re->prog.data)[state.pc].rep_min == 0) {
						dot_state.i -= char_len;
					}
					array_push_noscan((array*)&re->state_list, _MOV((regex__StateObj[]){ dot_state }));
					m_state = regex__Match_state__ist_quant_n;
					continue;
				}
				state.match_flag = true;
				l_ist = ((u32)(_const_regex__ist_dot_char));
				...
				m_state = regex__Match_state__ist_quant_p;
				continue;
			} else if (ist == _const_regex__ist_char_class_pos || ist == _const_regex__ist_char_class_neg) {
				bool next_check_flag = false;
				if (((regex__Token*)re->prog.data)[state.pc].rep >= ((regex__Token*)re->prog.data)[state.pc].rep_max) {
					(*(regex__StateObj*)array_pop_noscan(&re->state_list));
					m_state = regex__Match_state__ist_next;
				...
				if (((regex__Token*)re->prog.data)[state.pc].last_dot_flag == false && ((regex__Token*)re->prog.data)[state.pc].cc_check_pc >= 0 && ((regex__Token*)re->prog.data)[state.pc].rep >= ((regex__Token*)re->prog.data)[state.pc].rep_min) {
					rune ch_t = ch;
					int chk_pc = ((regex__Token*)re->prog.data)[state.pc].cc_check_pc;
					if (((regex__Token*)re->prog.data)[chk_pc].ist == _const_regex__ist_simple_char) {
						if (((regex__Token*)re->prog.data)[chk_pc].ch == ch_t) {
							next_check_flag = true;
						}
				...
				bool cc_neg = false;
				if (ist == _const_regex__ist_char_class_neg) {
					cc_neg = true;
				}
				bool cc_res = regex__RE_check_char_class(re, state.pc, ch);
				if (state.i >= ((int)(in_txt_len - 1)) && cc_neg && ((regex__Token*)re->prog.data)[state.pc].last_dot_flag) {
					m_state = regex__Match_state__ist_quant_n;
					continue;
				}
				if (cc_neg) {
				...
				if (cc_res) {
					state.match_flag = true;
					l_ist = ((u32)(_const_regex__ist_char_class_pos));
					if (state.first_match < 0) {
						state.first_match = state.i;
					}
					state.match_index = state.i;
				...
				m_state = regex__Match_state__ist_quant_n;
				continue;
			} else if (ist == _const_regex__ist_bsls_char) {
				bool next_check_flag = false;
				if (((regex__Token*)re->prog.data)[state.pc].rep >= ((regex__Token*)re->prog.data)[state.pc].rep_max) {
					(*(regex__StateObj*)array_pop_noscan(&re->state_list));
					m_state = regex__Match_state__ist_next;
				...
				if (((regex__Token*)re->prog.data)[state.pc].last_dot_flag == false && ((regex__Token*)re->prog.data)[state.pc].bsls_check_pc >= 0 && ((regex__Token*)re->prog.data)[state.pc].rep >= ((regex__Token*)re->prog.data)[state.pc].rep_min) {
					rune ch_t = ch;
					int chk_pc = ((regex__Token*)re->prog.data)[state.pc].bsls_check_pc;
					if (((regex__Token*)re->prog.data)[chk_pc].ist == _const_regex__ist_simple_char) {
						if (((regex__Token*)re->prog.data)[chk_pc].ch == ch_t) {
							next_check_flag = true;
						}
				...
				bool tmp_res = ((regex__Token*)re->prog.data)[state.pc].validator(((u8)(ch)));
				if (tmp_res == false) {
					m_state = regex__Match_state__ist_quant_n;
					continue;
				}
				...
				state.match_flag = false;
				if (((regex__Token*)re->prog.data)[state.pc].ch == ch && (state.i < (int)(in_txt_len - 1) || ((regex__Token*)re->prog.data)[state.pc].ch != 0)) {
					state.match_flag = true;
					l_ist = _const_regex__ist_simple_char;
					if (state.first_match < 0) {
						state.first_match = state.i;
					}
					state.match_index = state.i;
			...
			return (multi_return_int_int){.arg0=_const_regex__err_internal_error, .arg1=state.i};
		} else if (m_state == regex__Match_state__ist_quant_ng) {
			if (state.group_index < 0) {
				result = _const_regex__no_match_found;
				m_state = regex__Match_state__stop;
				continue;
			}
			int tmp_pc = ((int*)re->group_data.data)[state.group_index];
			int rep = ((regex__Token*)re->prog.data)[tmp_pc].group_rep;
			((regex__Token*)re->prog.data)[tmp_pc].group_rep = 0;
			if (rep >= ((regex__Token*)re->prog.data)[tmp_pc].rep_min) {
				state.i = ((int*)re->group_stack.data)[state.group_index];
				state.pc = tmp_pc;
				state.group_index--;
				m_state = regex__Match_state__ist_next;
				continue;
			} else if (((regex__Token*)re->prog.data)[tmp_pc].next_is_or) {
				state.i = ((int*)re->group_stack.data)[state.group_index];
				state.pc = (int)(((regex__Token*)re->prog.data)[(int)(tmp_pc + 1)].rep_min - 1);
				state.group_index--;
				m_state = regex__Match_state__ist_next;
				continue;
			} else if (rep > 0 && rep < ((regex__Token*)re->prog.data)[tmp_pc].rep_min) {
				if (state.group_index > 0) {
					state.group_index--;
					state.pc = tmp_pc;
					m_state = regex__Match_state__ist_quant_ng;
			...
			return (multi_return_int_int){.arg0=_const_regex__err_internal_error, .arg1=state.i};
		} else if (m_state == regex__Match_state__ist_quant_pg) {
			int tmp_pc = state.pc;
			if (state.group_index >= 0) {
				tmp_pc = ((int*)re->group_data.data)[state.group_index];
			}
			if (((regex__Token*)re->prog.data)[tmp_pc].group_neg == true) {
				result = _const_regex__no_match_found;
				m_state = regex__Match_state__stop;
				continue;
			}
			int rep = ((regex__Token*)re->prog.data)[tmp_pc].group_rep;
			if (rep < ((regex__Token*)re->prog.data)[tmp_pc].rep_min) {
				state.pc = ((regex__Token*)re->prog.data)[tmp_pc].goto_pc;
				m_state = regex__Match_state__ist_next;
				continue;
			} else if (rep == ((regex__Token*)re->prog.data)[tmp_pc].rep_max) {
				((regex__Token*)re->prog.data)[tmp_pc].group_rep = 0;
				state.group_index--;
				m_state = regex__Match_state__ist_next;
				continue;
			} else if (rep >= ((regex__Token*)re->prog.data)[tmp_pc].rep_min) {
				if (((regex__Token*)re->prog.data)[tmp_pc].greedy == true) {
					((regex__Token*)re->prog.data)[tmp_pc].group_rep = 0;
					state.group_index--;
					m_state = regex__Match_state__ist_next;
					continue;
				}
				state.pc = (int)(((regex__Token*)re->prog.data)[tmp_pc].goto_pc - 1);
				state.group_index--;
				m_state = regex__Match_state__ist_next;
				continue;
			}
			return (multi_return_int_int){.arg0=_const_regex__err_internal_error, .arg1=state.i};
		} else if (m_state == regex__Match_state__ist_quant_n) {
			int rep = ((regex__Token*)re->prog.data)[state.pc].rep;
			if (rep == 0 && ((regex__Token*)re->prog.data)[state.pc].rep_min == 0) {
				m_state = regex__Match_state__ist_next;
				continue;
			} else if (rep >= ((regex__Token*)re->prog.data)[state.pc].rep_min) {
				m_state = regex__Match_state__ist_next;
				continue;
			}
			if (((regex__Token*)re->prog.data)[state.pc].next_is_or) {
				state.match_index = -1;
				m_state = regex__Match_state__ist_next;
				continue;
			}
			...
			result = _const_regex__no_match_found;
			m_state = regex__Match_state__stop;
			if (re->state_list.len > 0 && (*(regex__StateObj*)array_last(re->state_list)).group_index == -1 && (*(regex__StateObj*)array_last(re->state_list)).last_dot_pc > 0) {
				if (ist == _const_regex__ist_dot_char || ist == _const_regex__ist_bsls_char) {
					return (multi_return_int_int){.arg0=_const_regex__no_match_found, .arg1=0};
				}
			}
			continue;
		} else if (m_state == regex__Match_state__ist_quant_p) {
			if (((re->flag & _const_regex__f_efm)) != 0) {
				return (multi_return_int_int){.arg0=state.i, .arg1=(int)(state.i + 1)};
			}
			int rep = ((regex__Token*)re->prog.data)[state.pc].rep;
			if (rep > 0 && rep < ((regex__Token*)re->prog.data)[state.pc].rep_min) {
				m_state = regex__Match_state__ist_load;
				continue;
			} else if (rep >= ((regex__Token*)re->prog.data)[state.pc].rep_min && rep < ((regex__Token*)re->prog.data)[state.pc].rep_max) {
				if (((regex__Token*)re->prog.data)[state.pc].greedy == true) {
					m_state = regex__Match_state__ist_next;
					continue;
				}
				m_state = regex__Match_state__ist_load;
				continue;
			} else if (rep == ((regex__Token*)re->prog.data)[state.pc].rep_max) {
				m_state = regex__Match_state__ist_next;
				continue;
			}
		}
	...
	if (state.match_index >= 0) {
		if (state.group_index < 0) {
			if (((regex__Token*)re->prog.data)[state.pc].ist == _const_regex__ist_prog_end) {
				if (((re->flag & _const_regex__f_src)) != 0) {
					return (multi_return_int_int){.arg0=state.first_match, .arg1=state.i};
				} else {
					return (multi_return_int_int){.arg0=0, .arg1=state.i};
				}
			}
			if (((regex__Token*)re->prog.data)[(int)(state.pc + 1)].ist == _const_regex__ist_prog_end || ((regex__Token*)re->prog.data)[state.pc].ist == _const_regex__ist_prog_end) {
				int rep = ((regex__Token*)re->prog.data)[state.pc].rep;
				if (rep >= ((regex__Token*)re->prog.data)[state.pc].rep_min && rep <= ((regex__Token*)re->prog.data)[state.pc].rep_max) {
					return (multi_return_int_int){.arg0=state.first_match, .arg1=state.i};
				}
				return (multi_return_int_int){.arg0=_const_regex__no_match_found, .arg1=state.i};
			}
...
_result_void regex__RE_compile_opt(regex__RE* re, string pattern) {
	multi_return_int_int mr_139 = regex__RE_impl_compile(re, pattern);
	int re_err = mr_139.arg0;
	int err_pos = mr_139.arg1;
	if (re_err != _const_regex__compile_ok) {
		strings__Builder err_msg = strings__new_builder(300);
		strings__Builder_write_string(&err_msg,  str_intp(2, _MOV((StrIntpData[]){{_SLIT("\nquery: "), 0xfe10, {.d_s = pattern}}, {_SLIT("\n"), 0, { .d_c = 0 }}})));
		string line = string_repeat(_SLIT("-"), err_pos);
		strings__Builder_write_string(&err_msg,  str_intp(2, _MOV((StrIntpData[]){{_SLIT("err  : "), 0xfe10, {.d_s = line}}, {_SLIT("^\n"), 0, { .d_c = 0 }}})));
		string err_str = regex__RE_get_parse_error_string(/*rec*/*re, re_err);
		strings__Builder_write_string(&err_msg,  str_intp(2, _MOV((StrIntpData[]){{_SLIT("ERROR: "), 0xfe10, {.d_s = err_str}}, {_SLIT("\n"), 0, { .d_c = 0 }}})));
		return (_result_void){ .is_error=true, .err=error_with_code(strings__Builder_str(&err_msg), re_err), .data={EMPTY_STRUCT_INITIALIZATION} };
	}
	return (_result_void){0};
}

regex__RE regex__new(void) {
	regex__RE re = ((regex__RE){.prog = __new_array(0, 0, sizeof(regex__Token)),.prog_len = 0,.cc = __new_array(0, 0, sizeof(regex__CharClass)),.cc_index = 0,.group_count = 0,.groups = __new_array_noscan(0, 0, sizeof(int)),.group_max_nested = 3,.group_max = 8,.state_list = __new_array_noscan(0, 0, sizeof(regex__StateObj)),.group_csave_flag = 0,.group_csave = __new_array_noscan(0, 0, sizeof(int)),.group_map = new_map_noscan_value(sizeof(string), sizeof(int), &map_hash_string, &map_eq_string, &map_clone_string, &map_free_string),.group_stack = __new_array_noscan(0, 0, sizeof(int)),.group_data = __new_array_noscan(0, 0, sizeof(int)),.flag = 0,.debug = 0,.log_func = regex__simple_log,.query = (string){.str=(byteptr)"", .is_lit=1},});
	re.prog = __new_array_with_default((int_literal)(_const_regex__max_code_len + 1), 0, sizeof(regex__Token), (voidptr)&(regex__Token[]){(regex__Token){.ist = 0,.ch_len = 0,.rep_min = 0,.rep_max = 0,.greedy = 0,.cc_index = -1,.rep = 0,.validator = ((void*)0),.group_neg = 0,.group_rep = 0,.group_id = -1,.goto_pc = -1,.next_is_or = 0,.dot_check_pc = -1,.bsls_check_pc = -1,.cc_check_pc = -1,.last_dot_flag = 0,.source_index = 0,}}[0]);
	re.cc = __new_array_with_default(_const_regex__max_code_len, 0, sizeof(regex__CharClass), (voidptr)&(regex__CharClass[]){(regex__CharClass){.cc_type = 0,.validator = ((void*)0),}}[0]);
	re.group_csave_flag = false;
	re.group_max_nested = 128;
	re.group_max = (_const_regex__max_code_len >> 1);
	re.group_stack = __new_array_with_default_noscan(re.group_max, 0, sizeof(int), &(int[]){-1});
	re.group_data = __new_array_with_default_noscan(re.group_max, 0, sizeof(int), &(int[]){-1});
	return re;
}

_result_regex__RE regex__regex_opt(string pattern) {
	regex__RE re = ((regex__RE){.prog = __new_array(0, 0, sizeof(regex__Token)),.prog_len = 0,.cc = __new_array(0, 0, sizeof(regex__CharClass)),.cc_index = 0,.group_count = 0,.groups = __new_array_noscan(0, 0, sizeof(int)),.group_max_nested = 3,.group_max = 8,.state_list = __new_array_noscan(0, 0, sizeof(regex__StateObj)),.group_csave_flag = 0,.group_csave = __new_array_noscan(0, 0, sizeof(int)),.group_map = new_map_noscan_value(sizeof(string), sizeof(int), &map_hash_string, &map_eq_string, &map_clone_string, &map_free_string),.group_stack = __new_array_noscan(0, 0, sizeof(int)),.group_data = __new_array_noscan(0, 0, sizeof(int)),.flag = 0,.debug = 0,.log_func = regex__simple_log,.query = (string){.str=(byteptr)"", .is_lit=1},});
	re.prog = __new_array_with_default((int)(pattern.len + 1), 0, sizeof(regex__Token), (voidptr)&(regex__Token[]){(regex__Token){.ist = 0,.ch_len = 0,.rep_min = 0,.rep_max = 0,.greedy = 0,.cc_index = -1,.rep = 0,.validator = ((void*)0),.group_neg = 0,.group_rep = 0,.group_id = -1,.goto_pc = -1,.next_is_or = 0,.dot_check_pc = -1,.bsls_check_pc = -1,.cc_check_pc = -1,.last_dot_flag = 0,.source_index = 0,}}[0]);
	re.cc = __new_array_with_default(pattern.len, 0, sizeof(regex__CharClass), (voidptr)&(regex__CharClass[]){(regex__CharClass){.cc_type = 0,.validator = ((void*)0),}}[0]);
	re.group_csave_flag = false;
	re.group_max_nested = (pattern.len >> 1);
	re.group_max = (pattern.len >> 1);
	re.group_stack = __new_array_with_default_noscan(re.group_max, 0, sizeof(int), &(int[]){-1});
	re.group_data = __new_array_with_default_noscan(re.group_max, 0, sizeof(int), &(int[]){-1});
	_result_void _t1 = regex__RE_compile_opt(&re, pattern);
	if (_t1.is_error) {
		_result_regex__RE _t2;
		memcpy(&_t2, &_t1, sizeof(_result));
		return _t2;
	}
	
 ;
	_result_regex__RE _t3;
	_result_ok(&(regex__RE[]) { re }, (_result*)(&_t3), sizeof(regex__RE));
	return _t3;
}
...
multi_return_regex__RE_int_int regex__regex_base(string pattern) {
	...
	re.group_stack = __new_array_with_default_noscan(re.group_max, 0, sizeof(int), &(int[]){-1});
	re.group_data = __new_array_with_default_noscan(re.group_max, 0, sizeof(int), &(int[]){-1});
	multi_return_int_int mr_1151 = regex__RE_impl_compile(&re, pattern);
	int re_err = mr_1151.arg0;
	int err_pos = mr_1151.arg1;
	return (multi_return_regex__RE_int_int){.arg0=re, .arg1=re_err, .arg2=err_pos};
}

multi_return_int_int regex__RE_get_group_bounds_by_name(regex__RE* re, string group_name) {
	if (_IN_MAP(ADDR(string, group_name), ADDR(map, re->group_map))) {
		int tmp_index = (int)((*(int*)map_get(ADDR(map, re->group_map), &(string[]){group_name}, &(int[]){ 0 })) - 1);
		int start = (*(int*)array_get(re->groups, (int)(tmp_index * 2)));
		int end = (*(int*)array_get(re->groups, (int)((int)(tmp_index * 2) + 1)));
		return (multi_return_int_int){.arg0=start, .arg1=end};
	}
...
string regex__RE_get_group_by_name(regex__RE* re, string in_txt, string group_name) {
	if (_IN_MAP(ADDR(string, group_name), ADDR(map, re->group_map))) {
		...
		if (start >= 0 && end > start) {
			string _t1 = string_substr(in_txt, start, end);
			return _t1;
		}
	}
	string _t2 = _SLIT("");
...
string regex__RE_get_group_by_id(regex__RE* re, string in_txt, int group_id) {
	if (group_id < ((re->groups.len >> 1))) {
		int index = (int)(group_id * 2);
		int start = (*(int*)array_get(re->groups, index));
		int end = (*(int*)array_get(re->groups, (int)(index + 1)));
		if (start >= 0 && end > start) {
			string _t1 = string_substr(in_txt, start, end);
			return _t1;
		}
...
multi_return_int_int regex__RE_get_group_bounds_by_id(regex__RE* re, int group_id) {
	if (group_id < re->group_count) {
		int index = (int)(group_id * 2);
		return (multi_return_int_int){.arg0=(*(int*)array_get(re->groups, index)), .arg1=(*(int*)array_get(re->groups, (int)(index + 1)))};
	}
	return (multi_return_int_int){.arg0=-1, .arg1=-1};
}

Array_regex__Re_group regex__RE_get_group_list(regex__RE* re) {
	Array_regex__Re_group res = __new_array_with_default_noscan((re->groups.len >> 1), 0, sizeof(regex__Re_group), (voidptr)&(regex__Re_group[]){(regex__Re_group){.start = -1,.end = -1,}}[0]);
	int gi = 0;
	for (;;) {
		if (!(gi < re->groups.len)) break;
		if ((*(int*)array_get(re->groups, gi)) >= 0) {
			int txt_st = (*(int*)array_get(re->groups, gi));
			int txt_en = (*(int*)array_get(re->groups, (int)(gi + 1)));
			if (txt_st >= 0 && txt_en > txt_st) {
				regex__Re_group tmp = ((regex__Re_group){.start = (*(int*)array_get(re->groups, gi)),.end = (*(int*)array_get(re->groups, (int)(gi + 1))),});
				array_set(&res, (gi >> 1), &(regex__Re_group[]) { tmp });
			} else {
				array_set(&res, (gi >> 1), &(regex__Re_group[]) { ((regex__Re_group){.start = -1,.end = -1,}) });
			}
		}
		gi += 2;
	}
...
multi_return_int_int regex__RE_match_string(regex__RE* re, string in_txt) {
	{ // Unsafe block
		multi_return_int_int mr_3702 = regex__RE_match_base(re, in_txt.str, (int)(in_txt.len + 1));
		int start = mr_3702.arg0;
		int end = mr_3702.arg1;
		if (end > in_txt.len) {
			end = in_txt.len;
		}
		if (start >= 0 && end > start) {
			if (((re->flag & _const_regex__f_ms)) != 0 && start > 0) {
				return (multi_return_int_int){.arg0=_const_regex__no_match_found, .arg1=0};
			}
			if (((re->flag & _const_regex__f_me)) != 0 && end < in_txt.len) {
				if ((Array_rune_contains(_const_regex__new_line_list, in_txt.str[ end]))) {
					return (multi_return_int_int){.arg0=start, .arg1=end};
				}
				return (multi_return_int_int){.arg0=_const_regex__no_match_found, .arg1=0};
			}
...
bool regex__RE_matches_string(regex__RE* re, string in_txt) {
	multi_return_int_int mr_4237 = regex__RE_match_string(re, in_txt);
	int start = mr_4237.arg0;
	bool _t1 = start != _const_regex__no_match_found;
	return _t1;
}
...
multi_return_int_int regex__RE_find(regex__RE* re, string in_txt) {
	...
	for (;;) {
		...
		int e = -1;
		{ // Unsafe block
			multi_return_int_int mr_5318 = regex__RE_match_base(re, in_txt.str + i, (int)((int)(in_txt.len - i) + 1));
			s = mr_5318.arg0;
			e = mr_5318.arg1;
			if (s >= 0 && e > s) {
				int gi = 0;
				for (;;) {
					if (!(gi < re->groups.len)) break;
					((int*)re->groups.data)[gi] += i;
					gi++;
				}
				if (((re->flag & _const_regex__f_ms)) != 0 && s > 0) {
					break;
				}
				if (((re->flag & _const_regex__f_me)) != 0 && (int)(i + e) < in_txt.len) {
					break;
				}
				return (multi_return_int_int){.arg0=(int)(i + s), .arg1=(int)(i + e)};
			}
			i++;
		}
	}
...
multi_return_int_int regex__RE_find_from(regex__RE* re, string in_txt, int start) {
	...
	for (;;) {
		...
		int e = -1;
		{ // Unsafe block
			string tmp_str = tos(in_txt.str + i, (int)(in_txt.len - i));
			multi_return_int_int mr_6353 = regex__RE_match_string(re, tmp_str);
			s = mr_6353.arg0;
			e = mr_6353.arg1;
		}
		if (s >= 0 && e > s) {
...
Array_int regex__RE_find_all(regex__RE* re, string in_txt) {
	...
	for (;;) {
		...
		int e = -1;
		{ // Unsafe block
			multi_return_int_int mr_7436 = regex__RE_match_base(re, in_txt.str + i, (int)((int)(in_txt.len + 1) - i));
			s = mr_7436.arg0;
			e = mr_7436.arg1;
			if (s >= 0 && e > s) {
				array_push_noscan((array*)&res, _MOV((int[]){ (int)(i + s) }));
				array_push_noscan((array*)&res, _MOV((int[]){ (int)(i + e) }));
				i += e;
				continue;
			}
			i++;
...
Array_string regex__RE_split(regex__RE* re, string in_txt) {
	Array_int pos = regex__RE_find_all(re, in_txt);
	Array_string sections = __new_array_with_default(0, (int)((int)(pos.len / 2) + 1), sizeof(string), 0);
	if (pos.len == 0) {
		Array_string _t1 = new_array_from_c_array(1, 1, sizeof(string), _MOV((string[1]){string_clone(in_txt)}));
		return _t1;
	}
	for (int i = 0; i < pos.len; i += 2) {
		if ((*(int*)array_get(pos, i)) == 0) {
			continue;
		}
		if (i == 0) {
			array_push((array*)&sections, _MOV((string[]){ string_clone(string_substr(in_txt, 0, (*(int*)array_get(pos, i)))) }));
		} else {
			array_push((array*)&sections, _MOV((string[]){ string_clone(string_substr(in_txt, (*(int*)array_get(pos, (int)(i - 1))), (*(int*)array_get(pos, i)))) }));
		}
	}
	if ((*(int*)array_get(pos, (int)(pos.len - 1))) != in_txt.len) {
		array_push((array*)&sections, _MOV((string[]){ string_clone(string_substr(in_txt, (*(int*)array_get(pos, (int)(pos.len - 1))), 2147483647)) }));
	}
	return sections;
}
...
Array_string regex__RE_find_all_str(regex__RE* re, string in_txt) {
	...
	for (;;) {
		...
		int e = -1;
		{ // Unsafe block
			multi_return_int_int mr_8854 = regex__RE_match_base(re, in_txt.str + i, (int)((int)(in_txt.len + 1) - i));
			s = mr_8854.arg0;
			e = mr_8854.arg1;
			if (s >= 0 && e > s) {
				string tmp_str = tos(in_txt.str + i, (int)(in_txt.len - i));
				int tmp_e = (e > tmp_str.len ? (tmp_str.len) : (e));
				array_push((array*)&res, _MOV((string[]){ string_clone(string_substr(tmp_str, 0, tmp_e)) }));
				i += e;
				continue;
			}
		}
...
string regex__RE_replace_simple(regex__RE* re, string in_txt, string repl) {
	...
	if (pos.len > 0) {
		...
		for (;;) {
			if (!(i < pos.len)) break;
			e1 = (*(int*)array_get(pos, i));
			res = string__plus(res, string__plus(string_substr(in_txt, s1, e1), repl));
			s1 = (*(int*)array_get(pos, (int)(i + 1)));
			i += 2;
		}
		res = string__plus(res, string_substr(in_txt, s1, 2147483647));
		return res;
	}
	return in_txt;
}
...
string regex__RE_replace_by_fn(regex__RE* re, string in_txt, string (*repl_fn)(regex__RE re, string in_txt, int start, int end)) {
	int i = 0;
	strings__Builder res = strings__new_builder(in_txt.len);
	int last_end = 0;
	for (;;) {
		if (!(i < in_txt.len)) break;
		multi_return_int_int mr_10490 = regex__RE_find_from(re, in_txt, i);
		int s = mr_10490.arg0;
		int e = mr_10490.arg1;
		if (s >= 0 && e > s) {
			if (last_end < s) {
				strings__Builder_write_string(&res, string_substr(in_txt, last_end, s));
			}
			string repl = repl_fn(*re, in_txt, s, e);
			strings__Builder_write_string(&res, repl);
			last_end = e;
			i = e;
		} else {
			break;
	...
	if (last_end >= 0 && last_end < in_txt.len) {
		strings__Builder_write_string(&res, string_substr(in_txt, last_end, 2147483647));
	}
	string _t1 = strings__Builder_str(&res);
	return _t1;
}
...
VV_LOCAL_SYMBOL string regex__RE_parsed_replace_string(regex__RE* re, string in_txt, string repl) {
	Array_string str_lst = string_split(repl, _SLIT("\\"));
	string res = (*(string*)array_get(str_lst, 0));
	int i = 1;
	for (;;) {
		if (!(i < str_lst.len)) break;
		string tmp = (*(string*)array_get(str_lst, i));
		if (tmp.len > 0 && string_at(tmp, 0) >= '0' && string_at(tmp, 0) <= '9') {
			int group_id = ((int)((rune)(string_at(tmp, 0) - '0')));
			string group = regex__RE_get_group_by_id(re, in_txt, group_id);
			res = string__plus(res,  str_intp(3, _MOV((StrIntpData[]){{_SLIT0, 0xfe10, {.d_s = group}}, {_SLIT0, 0xfe10, {.d_s = string_substr(tmp, 1, 2147483647)}}, {_SLIT0, 0, { .d_c = 0 }}})));
		} else {
			res = string__plus(res, string__plus(_SLIT("\\"), tmp));
		}
		i++;
	}
	return res;
...
string regex__RE_replace(regex__RE* re, string in_txt, string repl_str) {
	...
	for (;;) {
		if (!(i < in_txt.len)) break;
		multi_return_int_int mr_11977 = regex__RE_find_from(re, in_txt, i);
		int s = mr_11977.arg0;
		int e = mr_11977.arg1;
		if (s >= 0 && e > s) {
			if (last_end < s) {
			...
			string repl = regex__RE_parsed_replace_string(re, in_txt, repl_str);
			strings__Builder_write_string(&res, repl);
			last_end = e;
			i = e;
		} else {
...
string regex__RE_replace_n(regex__RE* re, string in_txt, string repl_str, int count) {
	...
	int i_p = 0;
	strings__Builder res = strings__new_builder(in_txt.len);
	Array_int lst = regex__RE_find_all(re, in_txt);
	if (count < 0) {
		lst = array_slice_ni(lst, (int)(count * 2), 2147483647);
	} else if (count > 0) {
		lst = array_slice_ni(lst, 0, (int)(count * 2));
	} else if (count == 0) {
		return in_txt;
	}
	for (;;) {
		if (!(index < lst.len)) break;
		i = (*(int*)array_get(lst, index));
		strings__Builder_write_string(&res, string_substr(in_txt, i_p, i));
		strings__Builder_write_string(&res, repl_str);
		index++;
		i_p = (*(int*)array_get(lst, index));
		index++;
	}
	i = i_p;
	strings__Builder_write_string(&res, string_substr(in_txt, i, 2147483647));
	string _t2 = strings__Builder_str(&res);
	return _t2;
}

VV_LOCAL_SYMBOL void main__run_regex(void) {
	string blurb = _SLIT("rounter_port=7000-8000");
	string query = _SLIT("(.)*=(.)*");
	_result_regex__RE _t1 = regex__regex_opt(query);
	if (_t1.is_error) {
		IError err = _t1.err;
	...
	;
 	...
 	regex__RE re =  (*(regex__RE*)_t1.data);
	Array_string arr = regex__RE_find_all_str(&re, blurb);
	for (int _t2 = 0; _t2 < arr.len; ++_t2) {
		string str = ((string*)arr.data)[_t2];
		println(str);
	}
}

VV_LOCAL_SYMBOL main__Vector3D main__look_at(main__Vector3D point, main__Vector3D dir) {
	main__Vector3D normail = ((main__Vector3D){.x = 1,.y = 2,.z = 3,});
	return normail;
}

VV_LOCAL_SYMBOL void main__main(void) {
	main__Vector3D p1 = ((main__Vector3D){.x = 0,.y = 1,.z = 2,});
	main__Vector3D p2 = ((main__Vector3D){.x = 0,.y = 1,.z = 1,});
	main__Vector3D dir = main__look_at(p1, p2);
	println(_SLIT("i do love with wzx"));
	wzx = ((main__Wzx){.age = 18,});
}
...
void _vinit(int ___argc, voidptr ___argv) {
	...
	// Initializations of consts for module regex
	_const_regex__v_regex_version = _SLIT("1.0 alpha");
	_const_regex__spaces = new_array_from_c_array_noscan(6, 6, sizeof(rune), _MOV((rune[6]){' ', '\t', '\n', '\r', '\v', '\f'}));
	_const_regex__new_line_list = new_array_from_c_array_noscan(2, 2, sizeof(rune), _MOV((rune[2]){'\n', '\r'}));
	_const_regex__bsls_validator_array = new_array_from_c_array(8, 8, sizeof(regex__BslsStruct), _MOV((regex__BslsStruct[8]){((regex__BslsStruct){.ch = 'w',.validator = (voidptr)regex__is_alnum,}), ((regex__BslsStruct){.ch = 'W',.validator = (voidptr)regex__is_not_alnum,}), ((regex__BslsStruct){.ch = 's',.validator = (voidptr)regex__is_space,}), ((regex__BslsStruct){.ch = 'S',.validator = (voidptr)regex__is_not_space,}), ((regex__BslsStruct){.ch = 'd',.validator = (voidptr)regex__is_digit,}), ((regex__BslsStruct){.ch = 'D',.validator = (voidptr)regex__is_not_digit,}), ((regex__BslsStruct){.ch = 'a',.validator = (voidptr)regex__is_lower,}), ((regex__BslsStruct){.ch = 'A',.validator = (voidptr)regex__is_upper,})}));
	_const_regex__bsls_escape_list = new_array_from_c_array_noscan(16, 16, sizeof(rune), _MOV((rune[16]){
		'\\', '|', '.', ':', '*', '+', '-', '{', '}',
		'[', ']', '(', ')', '?', '^', '!'}));
	_const_regex__quntifier_chars = new_array_from_c_array_noscan(4, 4, sizeof(rune), _MOV((rune[4]){((rune)('+')), '*', '?', '{'}));
	// Initializations of consts for module main
	wzx = *(main__Wzx*)&((main__Wzx[]){{.age = 0,}}[0]); // global
}
void _vcleanup(void) {
}
